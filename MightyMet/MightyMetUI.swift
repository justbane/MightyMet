...
//  MightyMetUI
//
//  Created by Justin Bane on 5/21/17.
...
public class MightyMetUI : NSObject {
    ...
    public dynamic class func drawTempoLight(frame: CGRect = CGRect(x: 0, y: 0, width: 100, height: 100), flash: Bool = false) {
        ...
        //// Color Declarations
        let darkRedWhiteColor2 = UIColor(red: 0.875, green: 0.027, blue: 0.027, alpha: 1.000)

        //// Gradient Declarations
        let darkRedWhite = CGGradient(colorsSpace: nil, colors: [MightyMetUI.darkRed.cgColor, MightyMetUI.darkRed.blended(withFraction: 0.5, of: darkRedWhiteColor2).cgColor, darkRedWhiteColor2.cgColor, darkRedWhiteColor2.blended(withFraction: 0.5, of: UIColor.white).cgColor, UIColor.white.cgColor] as CFArray, locations: [0, 0.12, 0.69, 0.96, 1])!
    ...
    public dynamic class func drawAdditionButton(frame: CGRect = CGRect(x: 7, y: 6, width: 87, height: 88), isTapped: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        // This non-generic function dramatically improves compilation times of complex expressions.
        func fastFloor(_ x: CGFloat) -> CGFloat { return floor(x) }
        ...
        //// Subframes
        let circle: CGRect = CGRect(x: frame.minX + fastFloor((frame.width - 69) * 0.44444 + 0.5), y: frame.minY + fastFloor((frame.height - 69) * 0.47368 + 0.5), width: 69, height: 69)
        let off: CGRect = CGRect(x: frame.minX + fastFloor((frame.width - 42) * 0.48889 + 0.5), y: frame.minY + fastFloor((frame.height - 42) * 0.47826 + 0.5), width: 42, height: 42)
        let on: CGRect = CGRect(x: frame.minX + fastFloor((frame.width - 42) * 0.48889 + 0.5), y: frame.minY + fastFloor((frame.height - 42) * 0.47826 + 0.5), width: 42, height: 42)
        ...
        //// Bezier 3 Drawing
        let bezier3Path = UIBezierPath()
        bezier3Path.move(to: CGPoint(x: off.minX + 23, y: off.minY + 0))
        bezier3Path.addCurve(to: CGPoint(x: off.minX + 23, y: off.minY + 19), controlPoint1: CGPoint(x: off.minX + 23, y: off.minY), controlPoint2: CGPoint(x: off.minX + 23, y: off.minY + 9.21))
        bezier3Path.addLine(to: CGPoint(x: off.minX + 42, y: off.minY + 19))
        bezier3Path.addLine(to: CGPoint(x: off.minX + 42, y: off.minY + 23))
        bezier3Path.addLine(to: CGPoint(x: off.minX + 23, y: off.minY + 23))
        bezier3Path.addCurve(to: CGPoint(x: off.minX + 23, y: off.minY + 42), controlPoint1: CGPoint(x: off.minX + 23, y: off.minY + 32.79), controlPoint2: CGPoint(x: off.minX + 23, y: off.minY + 42))
        bezier3Path.addLine(to: CGPoint(x: off.minX + 19, y: off.minY + 42))
        bezier3Path.addCurve(to: CGPoint(x: off.minX + 19, y: off.minY + 23), controlPoint1: CGPoint(x: off.minX + 19, y: off.minY + 42), controlPoint2: CGPoint(x: off.minX + 19, y: off.minY + 32.79))
        bezier3Path.addLine(to: CGPoint(x: off.minX, y: off.minY + 23))
        bezier3Path.addLine(to: CGPoint(x: off.minX, y: off.minY + 19))
        bezier3Path.addLine(to: CGPoint(x: off.minX + 19, y: off.minY + 19))
        bezier3Path.addCurve(to: CGPoint(x: off.minX + 19, y: off.minY), controlPoint1: CGPoint(x: off.minX + 19, y: off.minY + 9.21), controlPoint2: CGPoint(x: off.minX + 19, y: off.minY))
        bezier3Path.addLine(to: CGPoint(x: off.minX + 23, y: off.minY))
        bezier3Path.addLine(to: CGPoint(x: off.minX + 23, y: off.minY + 0))
        bezier3Path.close()
        MightyMetUI.transparent.setFill()
        bezier3Path.fill()
        ...
        if (isTapped) {
            ...
            //// Bezier 4 Drawing
            let bezier4Path = UIBezierPath()
            bezier4Path.move(to: CGPoint(x: on.minX + 23, y: on.minY + 0))
            bezier4Path.addCurve(to: CGPoint(x: on.minX + 23, y: on.minY + 19), controlPoint1: CGPoint(x: on.minX + 23, y: on.minY), controlPoint2: CGPoint(x: on.minX + 23, y: on.minY + 9.21))
            bezier4Path.addLine(to: CGPoint(x: on.minX + 42, y: on.minY + 19))
            bezier4Path.addLine(to: CGPoint(x: on.minX + 42, y: on.minY + 23))
            bezier4Path.addLine(to: CGPoint(x: on.minX + 23, y: on.minY + 23))
            bezier4Path.addCurve(to: CGPoint(x: on.minX + 23, y: on.minY + 42), controlPoint1: CGPoint(x: on.minX + 23, y: on.minY + 32.79), controlPoint2: CGPoint(x: on.minX + 23, y: on.minY + 42))
            bezier4Path.addLine(to: CGPoint(x: on.minX + 19, y: on.minY + 42))
            bezier4Path.addCurve(to: CGPoint(x: on.minX + 19, y: on.minY + 23), controlPoint1: CGPoint(x: on.minX + 19, y: on.minY + 42), controlPoint2: CGPoint(x: on.minX + 19, y: on.minY + 32.79))
            bezier4Path.addLine(to: CGPoint(x: on.minX, y: on.minY + 23))
            bezier4Path.addLine(to: CGPoint(x: on.minX, y: on.minY + 19))
            bezier4Path.addLine(to: CGPoint(x: on.minX + 19, y: on.minY + 19))
            bezier4Path.addCurve(to: CGPoint(x: on.minX + 19, y: on.minY), controlPoint1: CGPoint(x: on.minX + 19, y: on.minY + 9.21), controlPoint2: CGPoint(x: on.minX + 19, y: on.minY))
            bezier4Path.addLine(to: CGPoint(x: on.minX + 23, y: on.minY))
            bezier4Path.addLine(to: CGPoint(x: on.minX + 23, y: on.minY + 0))
            bezier4Path.close()
            MightyMetUI.yellowOrange.setFill()
            bezier4Path.fill()
