...
//  MightyMetUI
//
//  Created by Justin Bane on 6/8/17.
...
public class MightyMetUI : NSObject {
    ...
    private struct Cache {
        ...
        static let purple: UIColor = UIColor(red: 0.462, green: 0.000, blue: 1.000, alpha: 1.000)
        ...
        static let midBlue: UIColor = MightyMetUI.blue.withBrightness(0.6)
        ...
        static let darkRedWhiteColor2: UIColor = UIColor(red: 0.875, green: 0.027, blue: 0.027, alpha: 1.000)
        ...
        static let bluePink: CGGradient = CGGradient(colorsSpace: nil, colors: [MightyMetUI.purple.cgColor, MightyMetUI.fuscia.cgColor] as CFArray, locations: [0, 1])!
        static let darkRedWhite: CGGradient = CGGradient(colorsSpace: nil, colors: [MightyMetUI.darkRed.cgColor, MightyMetUI.darkRed.blended(withFraction: 0.5, of: MightyMetUI.darkRedWhiteColor2).cgColor, MightyMetUI.darkRedWhiteColor2.cgColor, MightyMetUI.darkRedWhiteColor2.blended(withFraction: 0.5, of: UIColor.white).cgColor, UIColor.white.cgColor] as CFArray, locations: [0, 0.12, 0.69, 0.96, 1])!
        static let darkRedWhiteOn: CGGradient = CGGradient(colorsSpace: nil, colors: [MightyMetUI.darkRedWhiteOnColor.cgColor, MightyMetUI.darkRedWhiteOnColor.blended(withFraction: 0.5, of: MightyMetUI.darkRedWhiteColor).cgColor, MightyMetUI.darkRedWhiteColor.cgColor, MightyMetUI.darkRedWhiteColor.blended(withFraction: 0.5, of: UIColor.white).cgColor, UIColor.white.cgColor] as CFArray, locations: [0, 0.16, 0.5, 0.95, 1])!
        static let blueDarkBlue: CGGradient = CGGradient(colorsSpace: nil, colors: [MightyMetUI.blue.cgColor, MightyMetUI.darkBlue.cgColor] as CFArray, locations: [0, 1])!
        static let midDarkBlue: CGGradient = CGGradient(colorsSpace: nil, colors: [MightyMetUI.midBlue.cgColor, MightyMetUI.darkBlue.cgColor] as CFArray, locations: [0, 1])!
    }
    ...
    public dynamic class var purple: UIColor { return Cache.purple }
    ...
    public dynamic class var midBlue: UIColor { return Cache.midBlue }
    ...
    public dynamic class var darkRedWhiteColor2: UIColor { return Cache.darkRedWhiteColor2 }

    //// Gradients

    public dynamic class var redYellow: CGGradient { return Cache.redYellow }
    public dynamic class var bluePink: CGGradient { return Cache.bluePink }
    public dynamic class var darkRedWhite: CGGradient { return Cache.darkRedWhite }
    public dynamic class var darkRedWhiteOn: CGGradient { return Cache.darkRedWhiteOn }
    public dynamic class var blueDarkBlue: CGGradient { return Cache.blueDarkBlue }
    public dynamic class var midDarkBlue: CGGradient { return Cache.midDarkBlue }
    ...
    public dynamic class func drawHertzSelector(frame: CGRect = CGRect(x: 0, y: 0, width: 200, height: 200), pitchAngle: CGFloat = 0, hertzText: String = "Name") {
        ...
        bezierPath.addClip()
        let bezierBounds = bezierPath.cgPath.boundingBoxOfPath
        context.drawLinearGradient(MightyMetUI.bluePink,
    ...
    public dynamic class func drawTempoLight(frame: CGRect = CGRect(x: 0, y: 0, width: 100, height: 100), flash: Bool = false) {
        ...
        context.drawRadialGradient(MightyMetUI.darkRedWhite,
        ...
        if (flash) {
            ...
            context.drawRadialGradient(MightyMetUI.darkRedWhiteOn,
    ...
    public dynamic class func drawDivisionButton(frame: CGRect = CGRect(x: 7, y: 6, width: 87, height: 88), isDivided: Bool = false) {
        ...
        //// Subframes
        let circle: CGRect = CGRect(x: frame.minX + fastFloor((frame.width - 69) * 0.44444 + 0.5), y: frame.minY + fastFloor((frame.height - 69) * 0.47368 + 0.5), width: 69, height: 69)
        let off: CGRect = CGRect(x: frame.minX + fastFloor((frame.width - 42) * 0.48889 + 0.5), y: frame.minY + fastFloor((frame.height - 38) * 0.48000 + 0.5), width: 42, height: 38)
        let on: CGRect = CGRect(x: frame.minX + fastFloor((frame.width - 42) * 0.48889 + 0.5), y: frame.minY + fastFloor((frame.height - 38) * 0.48000 + 0.5), width: 42, height: 38)
    ...
    public dynamic class func drawTripletButton(frame: CGRect = CGRect(x: 0, y: 0, width: 66, height: 62), isTriplet: Bool = true) {
        ...
        //// Subframes
        let circle: CGRect = CGRect(x: frame.minX + fastFloor(frame.width * 0.13636 + 0.5), y: frame.minY + fastFloor(frame.height * 0.09677 + 0.5), width: fastFloor(frame.width * 0.84848 + 0.5) - fastFloor(frame.width * 0.13636 + 0.5), height: fastFloor(frame.height * 0.85484 + 0.5) - fastFloor(frame.height * 0.09677 + 0.5))
        let off: CGRect = CGRect(x: frame.minX + fastFloor(frame.width * 0.28162 - 0.09) + 0.59, y: frame.minY + fastFloor(frame.height * 0.29032 + 0.5), width: fastFloor(frame.width * 0.67486 - 0.04) - fastFloor(frame.width * 0.28162 - 0.09) - 0.05, height: fastFloor(frame.height * 0.64782 + 0.34) - fastFloor(frame.height * 0.29032 + 0.5) + 0.16)
        let on: CGRect = CGRect(x: frame.minX + fastFloor(frame.width * 0.28162 - 0.09) + 0.59, y: frame.minY + fastFloor(frame.height * 0.30226 - 0.24) + 0.74, width: fastFloor(frame.width * 0.67486 - 0.04) - fastFloor(frame.width * 0.28162 - 0.09) - 0.05, height: fastFloor(frame.height * 0.64782 + 0.34) - fastFloor(frame.height * 0.30226 - 0.24) - 0.58)
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: circle.minX + 0.50000 * circle.width, y: circle.minY + 0.08696 * circle.height))
        bezierPath.addCurve(to: CGPoint(x: circle.minX + 0.27478 * circle.width, y: circle.minY + 0.15370 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.41691 * circle.width, y: circle.minY + 0.08696 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.33956 * circle.width, y: circle.minY + 0.11149 * circle.height))
        bezierPath.addCurve(to: CGPoint(x: circle.minX + 0.08696 * circle.width, y: circle.minY + 0.50000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.16171 * circle.width, y: circle.minY + 0.22739 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.08696 * circle.width, y: circle.minY + 0.35497 * circle.height))
        bezierPath.addCurve(to: CGPoint(x: circle.minX + 0.50000 * circle.width, y: circle.minY + 0.91304 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.08696 * circle.width, y: circle.minY + 0.72812 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.27188 * circle.width, y: circle.minY + 0.91304 * circle.height))
        bezierPath.addCurve(to: CGPoint(x: circle.minX + 0.91304 * circle.width, y: circle.minY + 0.50000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.72812 * circle.width, y: circle.minY + 0.91304 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.91304 * circle.width, y: circle.minY + 0.72812 * circle.height))
        bezierPath.addCurve(to: CGPoint(x: circle.minX + 0.50000 * circle.width, y: circle.minY + 0.08696 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.91304 * circle.width, y: circle.minY + 0.27188 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.72812 * circle.width, y: circle.minY + 0.08696 * circle.height))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: circle.minX + 1.00000 * circle.width, y: circle.minY + 0.50000 * circle.height))
        bezierPath.addCurve(to: CGPoint(x: circle.minX + 0.50000 * circle.width, y: circle.minY + 1.00000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 1.00000 * circle.width, y: circle.minY + 0.77614 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.77614 * circle.width, y: circle.minY + 1.00000 * circle.height))
        bezierPath.addCurve(to: CGPoint(x: circle.minX + 0.00000 * circle.width, y: circle.minY + 0.50000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.22386 * circle.width, y: circle.minY + 1.00000 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.00000 * circle.width, y: circle.minY + 0.77614 * circle.height))
        bezierPath.addCurve(to: CGPoint(x: circle.minX + 0.19793 * circle.width, y: circle.minY + 0.10153 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.00000 * circle.width, y: circle.minY + 0.33735 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.07766 * circle.width, y: circle.minY + 0.19284 * circle.height))
        bezierPath.addCurve(to: CGPoint(x: circle.minX + 0.50000 * circle.width, y: circle.minY + 0.00000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.28184 * circle.width, y: circle.minY + 0.03781 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.38651 * circle.width, y: circle.minY + 0.00000 * circle.height))
        bezierPath.addCurve(to: CGPoint(x: circle.minX + 1.00000 * circle.width, y: circle.minY + 0.50000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.77614 * circle.width, y: circle.minY + 0.00000 * circle.height), controlPoint2: CGPoint(x: circle.minX + 1.00000 * circle.width, y: circle.minY + 0.22386 * circle.height))
        bezierPath.close()
        MightyMetUI.transparent.setFill()
        bezierPath.fill()
        ...
        if (isTriplet) {
            ...
            bezier14Path.move(to: CGPoint(x: circle.minX + 0.50000 * circle.width, y: circle.minY + 0.08696 * circle.height))
            bezier14Path.addCurve(to: CGPoint(x: circle.minX + 0.27478 * circle.width, y: circle.minY + 0.15370 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.41691 * circle.width, y: circle.minY + 0.08696 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.33956 * circle.width, y: circle.minY + 0.11149 * circle.height))
            bezier14Path.addCurve(to: CGPoint(x: circle.minX + 0.08696 * circle.width, y: circle.minY + 0.50000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.16171 * circle.width, y: circle.minY + 0.22739 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.08696 * circle.width, y: circle.minY + 0.35497 * circle.height))
            bezier14Path.addCurve(to: CGPoint(x: circle.minX + 0.50000 * circle.width, y: circle.minY + 0.91304 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.08696 * circle.width, y: circle.minY + 0.72812 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.27188 * circle.width, y: circle.minY + 0.91304 * circle.height))
            bezier14Path.addCurve(to: CGPoint(x: circle.minX + 0.91304 * circle.width, y: circle.minY + 0.50000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.72812 * circle.width, y: circle.minY + 0.91304 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.91304 * circle.width, y: circle.minY + 0.72812 * circle.height))
            bezier14Path.addCurve(to: CGPoint(x: circle.minX + 0.50000 * circle.width, y: circle.minY + 0.08696 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.91304 * circle.width, y: circle.minY + 0.27188 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.72812 * circle.width, y: circle.minY + 0.08696 * circle.height))
            bezier14Path.close()
            bezier14Path.move(to: CGPoint(x: circle.minX + 1.00000 * circle.width, y: circle.minY + 0.50000 * circle.height))
            bezier14Path.addCurve(to: CGPoint(x: circle.minX + 0.50000 * circle.width, y: circle.minY + 1.00000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 1.00000 * circle.width, y: circle.minY + 0.77614 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.77614 * circle.width, y: circle.minY + 1.00000 * circle.height))
            bezier14Path.addCurve(to: CGPoint(x: circle.minX + 0.00000 * circle.width, y: circle.minY + 0.50000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.22386 * circle.width, y: circle.minY + 1.00000 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.00000 * circle.width, y: circle.minY + 0.77614 * circle.height))
            bezier14Path.addCurve(to: CGPoint(x: circle.minX + 0.19793 * circle.width, y: circle.minY + 0.10153 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.00000 * circle.width, y: circle.minY + 0.33735 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.07766 * circle.width, y: circle.minY + 0.19284 * circle.height))
            bezier14Path.addCurve(to: CGPoint(x: circle.minX + 0.50000 * circle.width, y: circle.minY + 0.00000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.28184 * circle.width, y: circle.minY + 0.03781 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.38651 * circle.width, y: circle.minY + 0.00000 * circle.height))
            bezier14Path.addCurve(to: CGPoint(x: circle.minX + 1.00000 * circle.width, y: circle.minY + 0.50000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.77614 * circle.width, y: circle.minY + 0.00000 * circle.height), controlPoint2: CGPoint(x: circle.minX + 1.00000 * circle.width, y: circle.minY + 0.22386 * circle.height))
            bezier14Path.close()
            MightyMetUI.yellowOrange.setFill()
            bezier14Path.fill()
        }
        ...
        //// Text Drawing
        let textRect = CGRect(x: off.minX + fastFloor(off.width * 0.43975 + 0.09) + 0.41, y: off.minY + fastFloor(off.height * 0.00000 + 0.5), width: fastFloor(off.width * 0.67093 + 0.09) - fastFloor(off.width * 0.43975 + 0.09), height: fastFloor(off.height * 0.45117 + 0.5) - fastFloor(off.height * 0.00000 + 0.5))
        ...
        //// Bezier 2 Drawing
        let bezier2Path = UIBezierPath()
        bezier2Path.move(to: CGPoint(x: off.minX + 0.11224 * off.width, y: off.minY + 0.18047 * off.height))
        bezier2Path.addCurve(to: CGPoint(x: off.minX + 0.34824 * off.width, y: off.minY + 0.18047 * off.height), controlPoint1: CGPoint(x: off.minX + 0.28081 * off.width, y: off.minY + 0.18047 * off.height), controlPoint2: CGPoint(x: off.minX + 0.28081 * off.width, y: off.minY + 0.18047 * off.height))
        bezier2Path.addCurve(to: CGPoint(x: off.minX + 0.38195 * off.width, y: off.minY + 0.18047 * off.height), controlPoint1: CGPoint(x: off.minX + 0.38195 * off.width, y: off.minY + 0.18047 * off.height), controlPoint2: CGPoint(x: off.minX + 0.38195 * off.width, y: off.minY + 0.18047 * off.height))
        bezier2Path.addLine(to: CGPoint(x: off.minX + 0.38195 * off.width, y: off.minY + 0.20303 * off.height))
        bezier2Path.addLine(to: CGPoint(x: off.minX + 0.38195 * off.width, y: off.minY + 0.22559 * off.height))
        bezier2Path.addLine(to: CGPoint(x: off.minX + 0.38195 * off.width, y: off.minY + 0.20303 * off.height))
        bezier2Path.addCurve(to: CGPoint(x: off.minX + 0.34824 * off.width, y: off.minY + 0.22559 * off.height), controlPoint1: CGPoint(x: off.minX + 0.38195 * off.width, y: off.minY + 0.22559 * off.height), controlPoint2: CGPoint(x: off.minX + 0.38195 * off.width, y: off.minY + 0.22559 * off.height))
        bezier2Path.addCurve(to: CGPoint(x: off.minX + 0.11224 * off.width, y: off.minY + 0.22559 * off.height), controlPoint1: CGPoint(x: off.minX + 0.28081 * off.width, y: off.minY + 0.22559 * off.height), controlPoint2: CGPoint(x: off.minX + 0.28081 * off.width, y: off.minY + 0.22559 * off.height))
        bezier2Path.addLine(to: CGPoint(x: off.minX + 0.11224 * off.width, y: off.minY + 0.18047 * off.height))
        bezier2Path.close()
        MightyMetUI.transparent.setFill()
        bezier2Path.fill()
        ...
        bezier3Path.move(to: CGPoint(x: off.minX + 0.72873 * off.width, y: off.minY + 0.18047 * off.height))
        bezier3Path.addCurve(to: CGPoint(x: off.minX + 0.96473 * off.width, y: off.minY + 0.18047 * off.height), controlPoint1: CGPoint(x: off.minX + 0.89730 * off.width, y: off.minY + 0.18047 * off.height), controlPoint2: CGPoint(x: off.minX + 0.89730 * off.width, y: off.minY + 0.18047 * off.height))
        bezier3Path.addCurve(to: CGPoint(x: off.minX + 0.99844 * off.width, y: off.minY + 0.18047 * off.height), controlPoint1: CGPoint(x: off.minX + 0.99844 * off.width, y: off.minY + 0.18047 * off.height), controlPoint2: CGPoint(x: off.minX + 0.99844 * off.width, y: off.minY + 0.18047 * off.height))
        bezier3Path.addLine(to: CGPoint(x: off.minX + 0.99844 * off.width, y: off.minY + 0.22559 * off.height))
        bezier3Path.addCurve(to: CGPoint(x: off.minX + 0.96473 * off.width, y: off.minY + 0.22559 * off.height), controlPoint1: CGPoint(x: off.minX + 0.99844 * off.width, y: off.minY + 0.22559 * off.height), controlPoint2: CGPoint(x: off.minX + 0.99844 * off.width, y: off.minY + 0.22559 * off.height))
        bezier3Path.addCurve(to: CGPoint(x: off.minX + 0.72873 * off.width, y: off.minY + 0.22559 * off.height), controlPoint1: CGPoint(x: off.minX + 0.89730 * off.width, y: off.minY + 0.22559 * off.height), controlPoint2: CGPoint(x: off.minX + 0.89730 * off.width, y: off.minY + 0.22559 * off.height))
        bezier3Path.addLine(to: CGPoint(x: off.minX + 0.72873 * off.width, y: off.minY + 0.18047 * off.height))
        bezier3Path.close()
        MightyMetUI.transparent.setFill()
        bezier3Path.fill()
        ...
        bezier4Path.move(to: CGPoint(x: off.minX + 0.11224 * off.width, y: off.minY + 0.45117 * off.height))
        bezier4Path.addCurve(to: CGPoint(x: off.minX + 0.88767 * off.width, y: off.minY + 0.45117 * off.height), controlPoint1: CGPoint(x: off.minX + 0.66612 * off.width, y: off.minY + 0.45117 * off.height), controlPoint2: CGPoint(x: off.minX + 0.66612 * off.width, y: off.minY + 0.45117 * off.height))
        bezier4Path.addCurve(to: CGPoint(x: off.minX + 0.99844 * off.width, y: off.minY + 0.45117 * off.height), controlPoint1: CGPoint(x: off.minX + 0.99844 * off.width, y: off.minY + 0.45117 * off.height), controlPoint2: CGPoint(x: off.minX + 0.99844 * off.width, y: off.minY + 0.45117 * off.height))
        bezier4Path.addLine(to: CGPoint(x: off.minX + 0.99844 * off.width, y: off.minY + 0.49629 * off.height))
        bezier4Path.addCurve(to: CGPoint(x: off.minX + 0.88767 * off.width, y: off.minY + 0.49629 * off.height), controlPoint1: CGPoint(x: off.minX + 0.99844 * off.width, y: off.minY + 0.49629 * off.height), controlPoint2: CGPoint(x: off.minX + 0.99844 * off.width, y: off.minY + 0.49629 * off.height))
        bezier4Path.addCurve(to: CGPoint(x: off.minX + 0.11224 * off.width, y: off.minY + 0.49629 * off.height), controlPoint1: CGPoint(x: off.minX + 0.66612 * off.width, y: off.minY + 0.49629 * off.height), controlPoint2: CGPoint(x: off.minX + 0.66612 * off.width, y: off.minY + 0.49629 * off.height))
        bezier4Path.addLine(to: CGPoint(x: off.minX + 0.11224 * off.width, y: off.minY + 0.45117 * off.height))
        bezier4Path.close()
        MightyMetUI.transparent.setFill()
        bezier4Path.fill()
        ...
        bezier5Path.move(to: CGPoint(x: off.minX + 0.11072 * off.width, y: off.minY + 0.90232 * off.height))
        bezier5Path.addCurve(to: CGPoint(x: off.minX + 0.11072 * off.width, y: off.minY + 0.55462 * off.height), controlPoint1: CGPoint(x: off.minX + 0.11072 * off.width, y: off.minY + 0.65832 * off.height), controlPoint2: CGPoint(x: off.minX + 0.11072 * off.width, y: off.minY + 0.65832 * off.height))
        bezier5Path.addCurve(to: CGPoint(x: off.minX + 0.11072 * off.width, y: off.minY + 0.49627 * off.height), controlPoint1: CGPoint(x: off.minX + 0.11072 * off.width, y: off.minY + 0.49627 * off.height), controlPoint2: CGPoint(x: off.minX + 0.11072 * off.width, y: off.minY + 0.49627 * off.height))
        bezier5Path.addLine(to: CGPoint(x: off.minX + 0.14925 * off.width, y: off.minY + 0.49627 * off.height))
        bezier5Path.addCurve(to: CGPoint(x: off.minX + 0.14925 * off.width, y: off.minY + 0.55462 * off.height), controlPoint1: CGPoint(x: off.minX + 0.14925 * off.width, y: off.minY + 0.49627 * off.height), controlPoint2: CGPoint(x: off.minX + 0.14925 * off.width, y: off.minY + 0.49627 * off.height))
        bezier5Path.addCurve(to: CGPoint(x: off.minX + 0.14925 * off.width, y: off.minY + 0.90232 * off.height), controlPoint1: CGPoint(x: off.minX + 0.14925 * off.width, y: off.minY + 0.65832 * off.height), controlPoint2: CGPoint(x: off.minX + 0.14925 * off.width, y: off.minY + 0.65832 * off.height))
        bezier5Path.addLine(to: CGPoint(x: off.minX + 0.11072 * off.width, y: off.minY + 0.90232 * off.height))
        bezier5Path.close()
        MightyMetUI.transparent.setFill()
        bezier5Path.fill()
        ...
        bezier6Path.move(to: CGPoint(x: off.minX + 0.53609 * off.width, y: off.minY + 0.90232 * off.height))
        bezier6Path.addCurve(to: CGPoint(x: off.minX + 0.53609 * off.width, y: off.minY + 0.54702 * off.height), controlPoint1: CGPoint(x: off.minX + 0.53609 * off.width, y: off.minY + 0.64854 * off.height), controlPoint2: CGPoint(x: off.minX + 0.53609 * off.width, y: off.minY + 0.64854 * off.height))
        bezier6Path.addCurve(to: CGPoint(x: off.minX + 0.53609 * off.width, y: off.minY + 0.49627 * off.height), controlPoint1: CGPoint(x: off.minX + 0.53609 * off.width, y: off.minY + 0.49627 * off.height), controlPoint2: CGPoint(x: off.minX + 0.53609 * off.width, y: off.minY + 0.49627 * off.height))
        bezier6Path.addLine(to: CGPoint(x: off.minX + 0.57462 * off.width, y: off.minY + 0.49627 * off.height))
        bezier6Path.addCurve(to: CGPoint(x: off.minX + 0.57462 * off.width, y: off.minY + 0.54702 * off.height), controlPoint1: CGPoint(x: off.minX + 0.57462 * off.width, y: off.minY + 0.49627 * off.height), controlPoint2: CGPoint(x: off.minX + 0.57462 * off.width, y: off.minY + 0.49627 * off.height))
        bezier6Path.addCurve(to: CGPoint(x: off.minX + 0.57462 * off.width, y: off.minY + 0.90232 * off.height), controlPoint1: CGPoint(x: off.minX + 0.57462 * off.width, y: off.minY + 0.64854 * off.height), controlPoint2: CGPoint(x: off.minX + 0.57462 * off.width, y: off.minY + 0.64854 * off.height))
        bezier6Path.addLine(to: CGPoint(x: off.minX + 0.53609 * off.width, y: off.minY + 0.90232 * off.height))
        bezier6Path.close()
        MightyMetUI.transparent.setFill()
        bezier6Path.fill()
        ...
        bezier7Path.move(to: CGPoint(x: off.minX + 0.96147 * off.width, y: off.minY + 0.90232 * off.height))
        bezier7Path.addCurve(to: CGPoint(x: off.minX + 0.96147 * off.width, y: off.minY + 0.54702 * off.height), controlPoint1: CGPoint(x: off.minX + 0.96147 * off.width, y: off.minY + 0.64854 * off.height), controlPoint2: CGPoint(x: off.minX + 0.96147 * off.width, y: off.minY + 0.64854 * off.height))
        bezier7Path.addCurve(to: CGPoint(x: off.minX + 0.96147 * off.width, y: off.minY + 0.49627 * off.height), controlPoint1: CGPoint(x: off.minX + 0.96147 * off.width, y: off.minY + 0.49627 * off.height), controlPoint2: CGPoint(x: off.minX + 0.96147 * off.width, y: off.minY + 0.49627 * off.height))
        bezier7Path.addLine(to: CGPoint(x: off.minX + 1.00000 * off.width, y: off.minY + 0.49627 * off.height))
        bezier7Path.addCurve(to: CGPoint(x: off.minX + 1.00000 * off.width, y: off.minY + 0.54702 * off.height), controlPoint1: CGPoint(x: off.minX + 1.00000 * off.width, y: off.minY + 0.49627 * off.height), controlPoint2: CGPoint(x: off.minX + 1.00000 * off.width, y: off.minY + 0.49627 * off.height))
        bezier7Path.addCurve(to: CGPoint(x: off.minX + 1.00000 * off.width, y: off.minY + 0.90232 * off.height), controlPoint1: CGPoint(x: off.minX + 1.00000 * off.width, y: off.minY + 0.64854 * off.height), controlPoint2: CGPoint(x: off.minX + 1.00000 * off.width, y: off.minY + 0.64854 * off.height))
        bezier7Path.addLine(to: CGPoint(x: off.minX + 0.96147 * off.width, y: off.minY + 0.90232 * off.height))
        bezier7Path.close()
        MightyMetUI.transparent.setFill()
        bezier7Path.fill()
        ...
        ovalPath.move(to: CGPoint(x: off.minX + 0.13948 * off.width, y: off.minY + 0.88092 * off.height))
        ovalPath.addCurve(to: CGPoint(x: off.minX + 0.10164 * off.width, y: off.minY + 0.98464 * off.height), controlPoint1: CGPoint(x: off.minX + 0.15544 * off.width, y: off.minY + 0.91328 * off.height), controlPoint2: CGPoint(x: off.minX + 0.13850 * off.width, y: off.minY + 0.95972 * off.height))
        ovalPath.addCurve(to: CGPoint(x: off.minX + 0.00601 * off.width, y: off.minY + 0.97115 * off.height), controlPoint1: CGPoint(x: off.minX + 0.06478 * off.width, y: off.minY + 1.00956 * off.height), controlPoint2: CGPoint(x: off.minX + 0.02197 * off.width, y: off.minY + 1.00352 * off.height))
        ovalPath.addCurve(to: CGPoint(x: off.minX + 0.04385 * off.width, y: off.minY + 0.86742 * off.height), controlPoint1: CGPoint(x: off.minX + -0.00995 * off.width, y: off.minY + 0.93878 * off.height), controlPoint2: CGPoint(x: off.minX + 0.00699 * off.width, y: off.minY + 0.89234 * off.height))
        ovalPath.addCurve(to: CGPoint(x: off.minX + 0.13948 * off.width, y: off.minY + 0.88092 * off.height), controlPoint1: CGPoint(x: off.minX + 0.08070 * off.width, y: off.minY + 0.84251 * off.height), controlPoint2: CGPoint(x: off.minX + 0.12352 * off.width, y: off.minY + 0.84855 * off.height))
        ovalPath.close()
        MightyMetUI.transparent.setFill()
        ovalPath.fill()
        ...
        oval2Path.move(to: CGPoint(x: off.minX + 0.56331 * off.width, y: off.minY + 0.88092 * off.height))
        oval2Path.addCurve(to: CGPoint(x: off.minX + 0.52548 * off.width, y: off.minY + 0.98464 * off.height), controlPoint1: CGPoint(x: off.minX + 0.57927 * off.width, y: off.minY + 0.91328 * off.height), controlPoint2: CGPoint(x: off.minX + 0.56233 * off.width, y: off.minY + 0.95972 * off.height))
        oval2Path.addCurve(to: CGPoint(x: off.minX + 0.42984 * off.width, y: off.minY + 0.97115 * off.height), controlPoint1: CGPoint(x: off.minX + 0.48862 * off.width, y: off.minY + 1.00956 * off.height), controlPoint2: CGPoint(x: off.minX + 0.44580 * off.width, y: off.minY + 1.00352 * off.height))
        oval2Path.addCurve(to: CGPoint(x: off.minX + 0.46768 * off.width, y: off.minY + 0.86742 * off.height), controlPoint1: CGPoint(x: off.minX + 0.41388 * off.width, y: off.minY + 0.93878 * off.height), controlPoint2: CGPoint(x: off.minX + 0.43082 * off.width, y: off.minY + 0.89234 * off.height))
        oval2Path.addCurve(to: CGPoint(x: off.minX + 0.56331 * off.width, y: off.minY + 0.88092 * off.height), controlPoint1: CGPoint(x: off.minX + 0.50454 * off.width, y: off.minY + 0.84251 * off.height), controlPoint2: CGPoint(x: off.minX + 0.54735 * off.width, y: off.minY + 0.84855 * off.height))
        oval2Path.close()
        MightyMetUI.transparent.setFill()
        oval2Path.fill()
        ...
        oval5Path.move(to: CGPoint(x: off.minX + 0.98715 * off.width, y: off.minY + 0.88092 * off.height))
        oval5Path.addCurve(to: CGPoint(x: off.minX + 0.94931 * off.width, y: off.minY + 0.98464 * off.height), controlPoint1: CGPoint(x: off.minX + 1.00311 * off.width, y: off.minY + 0.91328 * off.height), controlPoint2: CGPoint(x: off.minX + 0.98617 * off.width, y: off.minY + 0.95972 * off.height))
        oval5Path.addCurve(to: CGPoint(x: off.minX + 0.85368 * off.width, y: off.minY + 0.97115 * off.height), controlPoint1: CGPoint(x: off.minX + 0.91245 * off.width, y: off.minY + 1.00956 * off.height), controlPoint2: CGPoint(x: off.minX + 0.86964 * off.width, y: off.minY + 1.00352 * off.height))
        oval5Path.addCurve(to: CGPoint(x: off.minX + 0.89151 * off.width, y: off.minY + 0.86742 * off.height), controlPoint1: CGPoint(x: off.minX + 0.83772 * off.width, y: off.minY + 0.93878 * off.height), controlPoint2: CGPoint(x: off.minX + 0.85466 * off.width, y: off.minY + 0.89234 * off.height))
        oval5Path.addCurve(to: CGPoint(x: off.minX + 0.98715 * off.width, y: off.minY + 0.88092 * off.height), controlPoint1: CGPoint(x: off.minX + 0.92837 * off.width, y: off.minY + 0.84251 * off.height), controlPoint2: CGPoint(x: off.minX + 0.97119 * off.width, y: off.minY + 0.84855 * off.height))
        oval5Path.close()
        MightyMetUI.transparent.setFill()
        oval5Path.fill()
        ...
        if (isTriplet) {
            ...
            text2Path.move(to: CGPoint(x: on.minX + 0.52876 * on.width, y: on.minY + 0.15170 * on.height))
            text2Path.addLine(to: CGPoint(x: on.minX + 0.54070 * on.width, y: on.minY + 0.15170 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.59484 * on.width, y: on.minY + 0.13372 * on.height), controlPoint1: CGPoint(x: on.minX + 0.56382 * on.width, y: on.minY + 0.15170 * on.height), controlPoint2: CGPoint(x: on.minX + 0.58186 * on.width, y: on.minY + 0.14571 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.61429 * on.width, y: on.minY + 0.07888 * on.height), controlPoint1: CGPoint(x: on.minX + 0.60781 * on.width, y: on.minY + 0.12174 * on.height), controlPoint2: CGPoint(x: on.minX + 0.61429 * on.width, y: on.minY + 0.10346 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.60081 * on.width, y: on.minY + 0.04154 * on.height), controlPoint1: CGPoint(x: on.minX + 0.61429 * on.width, y: on.minY + 0.06270 * on.height), controlPoint2: CGPoint(x: on.minX + 0.60980 * on.width, y: on.minY + 0.05025 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.56806 * on.width, y: on.minY + 0.02847 * on.height), controlPoint1: CGPoint(x: on.minX + 0.59182 * on.width, y: on.minY + 0.03283 * on.height), controlPoint2: CGPoint(x: on.minX + 0.58090 * on.width, y: on.minY + 0.02847 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.53511 * on.width, y: on.minY + 0.03874 * on.height), controlPoint1: CGPoint(x: on.minX + 0.55598 * on.width, y: on.minY + 0.02847 * on.height), controlPoint2: CGPoint(x: on.minX + 0.54500 * on.width, y: on.minY + 0.03189 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.51142 * on.width, y: on.minY + 0.06908 * on.height), controlPoint1: CGPoint(x: on.minX + 0.52522 * on.width, y: on.minY + 0.04559 * on.height), controlPoint2: CGPoint(x: on.minX + 0.51732 * on.width, y: on.minY + 0.05570 * on.height))
            text2Path.addLine(to: CGPoint(x: on.minX + 0.48907 * on.width, y: on.minY + 0.05368 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.56921 * on.width, y: on.minY + -0.00000 * on.height), controlPoint1: CGPoint(x: on.minX + 0.50833 * on.width, y: on.minY + 0.01789 * on.height), controlPoint2: CGPoint(x: on.minX + 0.53505 * on.width, y: on.minY + -0.00000 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.59695 * on.width, y: on.minY + 0.00490 * on.height), controlPoint1: CGPoint(x: on.minX + 0.57897 * on.width, y: on.minY + -0.00000 * on.height), controlPoint2: CGPoint(x: on.minX + 0.58822 * on.width, y: on.minY + 0.00163 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.62007 * on.width, y: on.minY + 0.01984 * on.height), controlPoint1: CGPoint(x: on.minX + 0.60569 * on.width, y: on.minY + 0.00817 * on.height), controlPoint2: CGPoint(x: on.minX + 0.61339 * on.width, y: on.minY + 0.01315 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.63606 * on.width, y: on.minY + 0.04457 * on.height), controlPoint1: CGPoint(x: on.minX + 0.62675 * on.width, y: on.minY + 0.02653 * on.height), controlPoint2: CGPoint(x: on.minX + 0.63208 * on.width, y: on.minY + 0.03477 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.64203 * on.width, y: on.minY + 0.07888 * on.height), controlPoint1: CGPoint(x: on.minX + 0.64004 * on.width, y: on.minY + 0.05438 * on.height), controlPoint2: CGPoint(x: on.minX + 0.64203 * on.width, y: on.minY + 0.06581 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.63857 * on.width, y: on.minY + 0.10689 * on.height), controlPoint1: CGPoint(x: on.minX + 0.64203 * on.width, y: on.minY + 0.08853 * on.height), controlPoint2: CGPoint(x: on.minX + 0.64088 * on.width, y: on.minY + 0.09786 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.62778 * on.width, y: on.minY + 0.13186 * on.height), controlPoint1: CGPoint(x: on.minX + 0.63626 * on.width, y: on.minY + 0.11591 * on.height), controlPoint2: CGPoint(x: on.minX + 0.63266 * on.width, y: on.minY + 0.12423 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.60909 * on.width, y: on.minY + 0.15193 * on.height), controlPoint1: CGPoint(x: on.minX + 0.62290 * on.width, y: on.minY + 0.13948 * on.height), controlPoint2: CGPoint(x: on.minX + 0.61667 * on.width, y: on.minY + 0.14617 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.58231 * on.width, y: on.minY + 0.16570 * on.height), controlPoint1: CGPoint(x: on.minX + 0.60151 * on.width, y: on.minY + 0.15769 * on.height), controlPoint2: CGPoint(x: on.minX + 0.59259 * on.width, y: on.minY + 0.16227 * on.height))
            text2Path.addLine(to: CGPoint(x: on.minX + 0.58231 * on.width, y: on.minY + 0.16663 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.59965 * on.width, y: on.minY + 0.17550 * on.height), controlPoint1: CGPoint(x: on.minX + 0.58848 * on.width, y: on.minY + 0.16850 * on.height), controlPoint2: CGPoint(x: on.minX + 0.59426 * on.width, y: on.minY + 0.17145 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.61391 * on.width, y: on.minY + 0.19067 * on.height), controlPoint1: CGPoint(x: on.minX + 0.60505 * on.width, y: on.minY + 0.17954 * on.height), controlPoint2: CGPoint(x: on.minX + 0.60980 * on.width, y: on.minY + 0.18460 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.62354 * on.width, y: on.minY + 0.21144 * on.height), controlPoint1: CGPoint(x: on.minX + 0.61802 * on.width, y: on.minY + 0.19674 * on.height), controlPoint2: CGPoint(x: on.minX + 0.62123 * on.width, y: on.minY + 0.20366 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.62701 * on.width, y: on.minY + 0.23618 * on.height), controlPoint1: CGPoint(x: on.minX + 0.62585 * on.width, y: on.minY + 0.21922 * on.height), controlPoint2: CGPoint(x: on.minX + 0.62701 * on.width, y: on.minY + 0.22746 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.62027 * on.width, y: on.minY + 0.28052 * on.height), controlPoint1: CGPoint(x: on.minX + 0.62701 * on.width, y: on.minY + 0.25205 * on.height), controlPoint2: CGPoint(x: on.minX + 0.62476 * on.width, y: on.minY + 0.26683 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.60100 * on.width, y: on.minY + 0.31576 * on.height), controlPoint1: CGPoint(x: on.minX + 0.61577 * on.width, y: on.minY + 0.29421 * on.height), controlPoint2: CGPoint(x: on.minX + 0.60935 * on.width, y: on.minY + 0.30596 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.57075 * on.width, y: on.minY + 0.33886 * on.height), controlPoint1: CGPoint(x: on.minX + 0.59265 * on.width, y: on.minY + 0.32556 * on.height), controlPoint2: CGPoint(x: on.minX + 0.58257 * on.width, y: on.minY + 0.33326 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.53107 * on.width, y: on.minY + 0.34726 * on.height), controlPoint1: CGPoint(x: on.minX + 0.55894 * on.width, y: on.minY + 0.34446 * on.height), controlPoint2: CGPoint(x: on.minX + 0.54571 * on.width, y: on.minY + 0.34726 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.50275 * on.width, y: on.minY + 0.34260 * on.height), controlPoint1: CGPoint(x: on.minX + 0.52105 * on.width, y: on.minY + 0.34726 * on.height), controlPoint2: CGPoint(x: on.minX + 0.51161 * on.width, y: on.minY + 0.34571 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.47867 * on.width, y: on.minY + 0.32929 * on.height), controlPoint1: CGPoint(x: on.minX + 0.49389 * on.width, y: on.minY + 0.33949 * on.height), controlPoint2: CGPoint(x: on.minX + 0.48586 * on.width, y: on.minY + 0.33505 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.45998 * on.width, y: on.minY + 0.30806 * on.height), controlPoint1: CGPoint(x: on.minX + 0.47147 * on.width, y: on.minY + 0.32354 * on.height), controlPoint2: CGPoint(x: on.minX + 0.46524 * on.width, y: on.minY + 0.31646 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.44823 * on.width, y: on.minY + 0.27959 * on.height), controlPoint1: CGPoint(x: on.minX + 0.45471 * on.width, y: on.minY + 0.29966 * on.height), controlPoint2: CGPoint(x: on.minX + 0.45080 * on.width, y: on.minY + 0.29017 * on.height))
            text2Path.addLine(to: CGPoint(x: on.minX + 0.47558 * on.width, y: on.minY + 0.26792 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.48290 * on.width, y: on.minY + 0.28939 * on.height), controlPoint1: CGPoint(x: on.minX + 0.47687 * on.width, y: on.minY + 0.27601 * on.height), controlPoint2: CGPoint(x: on.minX + 0.47931 * on.width, y: on.minY + 0.28316 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.49600 * on.width, y: on.minY + 0.30526 * on.height), controlPoint1: CGPoint(x: on.minX + 0.48650 * on.width, y: on.minY + 0.29561 * on.height), controlPoint2: CGPoint(x: on.minX + 0.49087 * on.width, y: on.minY + 0.30090 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.51334 * on.width, y: on.minY + 0.31506 * on.height), controlPoint1: CGPoint(x: on.minX + 0.50114 * on.width, y: on.minY + 0.30961 * on.height), controlPoint2: CGPoint(x: on.minX + 0.50692 * on.width, y: on.minY + 0.31288 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.53338 * on.width, y: on.minY + 0.31833 * on.height), controlPoint1: CGPoint(x: on.minX + 0.51976 * on.width, y: on.minY + 0.31724 * on.height), controlPoint2: CGPoint(x: on.minX + 0.52644 * on.width, y: on.minY + 0.31833 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.55958 * on.width, y: on.minY + 0.31273 * on.height), controlPoint1: CGPoint(x: on.minX + 0.54288 * on.width, y: on.minY + 0.31833 * on.height), controlPoint2: CGPoint(x: on.minX + 0.55162 * on.width, y: on.minY + 0.31646 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.58019 * on.width, y: on.minY + 0.29686 * on.height), controlPoint1: CGPoint(x: on.minX + 0.56754 * on.width, y: on.minY + 0.30899 * on.height), controlPoint2: CGPoint(x: on.minX + 0.57441 * on.width, y: on.minY + 0.30370 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.59368 * on.width, y: on.minY + 0.27212 * on.height), controlPoint1: CGPoint(x: on.minX + 0.58597 * on.width, y: on.minY + 0.29001 * on.height), controlPoint2: CGPoint(x: on.minX + 0.59047 * on.width, y: on.minY + 0.28176 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.59850 * on.width, y: on.minY + 0.23944 * on.height), controlPoint1: CGPoint(x: on.minX + 0.59689 * on.width, y: on.minY + 0.26247 * on.height), controlPoint2: CGPoint(x: on.minX + 0.59850 * on.width, y: on.minY + 0.25158 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.58135 * on.width, y: on.minY + 0.19394 * on.height), controlPoint1: CGPoint(x: on.minX + 0.59850 * on.width, y: on.minY + 0.21860 * on.height), controlPoint2: CGPoint(x: on.minX + 0.59278 * on.width, y: on.minY + 0.20343 * on.height))
            text2Path.addCurve(to: CGPoint(x: on.minX + 0.53646 * on.width, y: on.minY + 0.17970 * on.height), controlPoint1: CGPoint(x: on.minX + 0.56992 * on.width, y: on.minY + 0.18445 * on.height), controlPoint2: CGPoint(x: on.minX + 0.55496 * on.width, y: on.minY + 0.17970 * on.height))
            text2Path.addLine(to: CGPoint(x: on.minX + 0.52452 * on.width, y: on.minY + 0.17970 * on.height))
            text2Path.addLine(to: CGPoint(x: on.minX + 0.52876 * on.width, y: on.minY + 0.15170 * on.height))
            text2Path.close()
            MightyMetUI.yellowOrange.setFill()
            text2Path.fill()
            ...
            bezier8Path.move(to: CGPoint(x: on.minX + 0.11224 * on.width, y: on.minY + 0.15216 * on.height))
            bezier8Path.addCurve(to: CGPoint(x: on.minX + 0.34824 * on.width, y: on.minY + 0.15216 * on.height), controlPoint1: CGPoint(x: on.minX + 0.28081 * on.width, y: on.minY + 0.15216 * on.height), controlPoint2: CGPoint(x: on.minX + 0.28081 * on.width, y: on.minY + 0.15216 * on.height))
            bezier8Path.addCurve(to: CGPoint(x: on.minX + 0.38195 * on.width, y: on.minY + 0.15216 * on.height), controlPoint1: CGPoint(x: on.minX + 0.38195 * on.width, y: on.minY + 0.15216 * on.height), controlPoint2: CGPoint(x: on.minX + 0.38195 * on.width, y: on.minY + 0.15216 * on.height))
            bezier8Path.addLine(to: CGPoint(x: on.minX + 0.38195 * on.width, y: on.minY + 0.17550 * on.height))
            bezier8Path.addLine(to: CGPoint(x: on.minX + 0.38195 * on.width, y: on.minY + 0.19884 * on.height))
            bezier8Path.addLine(to: CGPoint(x: on.minX + 0.38195 * on.width, y: on.minY + 0.17550 * on.height))
            bezier8Path.addCurve(to: CGPoint(x: on.minX + 0.34824 * on.width, y: on.minY + 0.19884 * on.height), controlPoint1: CGPoint(x: on.minX + 0.38195 * on.width, y: on.minY + 0.19884 * on.height), controlPoint2: CGPoint(x: on.minX + 0.38195 * on.width, y: on.minY + 0.19884 * on.height))
            bezier8Path.addCurve(to: CGPoint(x: on.minX + 0.11224 * on.width, y: on.minY + 0.19884 * on.height), controlPoint1: CGPoint(x: on.minX + 0.28081 * on.width, y: on.minY + 0.19884 * on.height), controlPoint2: CGPoint(x: on.minX + 0.28081 * on.width, y: on.minY + 0.19884 * on.height))
            bezier8Path.addLine(to: CGPoint(x: on.minX + 0.11224 * on.width, y: on.minY + 0.15216 * on.height))
            bezier8Path.close()
            MightyMetUI.yellowOrange.setFill()
            bezier8Path.fill()
            ...
            bezier9Path.move(to: CGPoint(x: on.minX + 0.72873 * on.width, y: on.minY + 0.15216 * on.height))
            bezier9Path.addCurve(to: CGPoint(x: on.minX + 0.96473 * on.width, y: on.minY + 0.15216 * on.height), controlPoint1: CGPoint(x: on.minX + 0.89730 * on.width, y: on.minY + 0.15216 * on.height), controlPoint2: CGPoint(x: on.minX + 0.89730 * on.width, y: on.minY + 0.15216 * on.height))
            bezier9Path.addCurve(to: CGPoint(x: on.minX + 0.99844 * on.width, y: on.minY + 0.15216 * on.height), controlPoint1: CGPoint(x: on.minX + 0.99844 * on.width, y: on.minY + 0.15216 * on.height), controlPoint2: CGPoint(x: on.minX + 0.99844 * on.width, y: on.minY + 0.15216 * on.height))
            bezier9Path.addLine(to: CGPoint(x: on.minX + 0.99844 * on.width, y: on.minY + 0.19884 * on.height))
            bezier9Path.addCurve(to: CGPoint(x: on.minX + 0.96473 * on.width, y: on.minY + 0.19884 * on.height), controlPoint1: CGPoint(x: on.minX + 0.99844 * on.width, y: on.minY + 0.19884 * on.height), controlPoint2: CGPoint(x: on.minX + 0.99844 * on.width, y: on.minY + 0.19884 * on.height))
            bezier9Path.addCurve(to: CGPoint(x: on.minX + 0.72873 * on.width, y: on.minY + 0.19884 * on.height), controlPoint1: CGPoint(x: on.minX + 0.89730 * on.width, y: on.minY + 0.19884 * on.height), controlPoint2: CGPoint(x: on.minX + 0.89730 * on.width, y: on.minY + 0.19884 * on.height))
            bezier9Path.addLine(to: CGPoint(x: on.minX + 0.72873 * on.width, y: on.minY + 0.15216 * on.height))
            bezier9Path.close()
            MightyMetUI.yellowOrange.setFill()
            bezier9Path.fill()
            ...
            bezier10Path.move(to: CGPoint(x: on.minX + 0.11224 * on.width, y: on.minY + 0.43221 * on.height))
            bezier10Path.addCurve(to: CGPoint(x: on.minX + 0.88767 * on.width, y: on.minY + 0.43221 * on.height), controlPoint1: CGPoint(x: on.minX + 0.66612 * on.width, y: on.minY + 0.43221 * on.height), controlPoint2: CGPoint(x: on.minX + 0.66612 * on.width, y: on.minY + 0.43221 * on.height))
            bezier10Path.addCurve(to: CGPoint(x: on.minX + 0.99844 * on.width, y: on.minY + 0.43221 * on.height), controlPoint1: CGPoint(x: on.minX + 0.99844 * on.width, y: on.minY + 0.43221 * on.height), controlPoint2: CGPoint(x: on.minX + 0.99844 * on.width, y: on.minY + 0.43221 * on.height))
            bezier10Path.addLine(to: CGPoint(x: on.minX + 0.99844 * on.width, y: on.minY + 0.47889 * on.height))
            bezier10Path.addCurve(to: CGPoint(x: on.minX + 0.88767 * on.width, y: on.minY + 0.47889 * on.height), controlPoint1: CGPoint(x: on.minX + 0.99844 * on.width, y: on.minY + 0.47889 * on.height), controlPoint2: CGPoint(x: on.minX + 0.99844 * on.width, y: on.minY + 0.47889 * on.height))
            bezier10Path.addCurve(to: CGPoint(x: on.minX + 0.11224 * on.width, y: on.minY + 0.47889 * on.height), controlPoint1: CGPoint(x: on.minX + 0.66612 * on.width, y: on.minY + 0.47889 * on.height), controlPoint2: CGPoint(x: on.minX + 0.66612 * on.width, y: on.minY + 0.47889 * on.height))
            bezier10Path.addLine(to: CGPoint(x: on.minX + 0.11224 * on.width, y: on.minY + 0.43221 * on.height))
            bezier10Path.close()
            MightyMetUI.yellowOrange.setFill()
            bezier10Path.fill()
            ...
            bezier11Path.move(to: CGPoint(x: on.minX + 0.11072 * on.width, y: on.minY + 0.89894 * on.height))
            bezier11Path.addCurve(to: CGPoint(x: on.minX + 0.11072 * on.width, y: on.minY + 0.53924 * on.height), controlPoint1: CGPoint(x: on.minX + 0.11072 * on.width, y: on.minY + 0.64652 * on.height), controlPoint2: CGPoint(x: on.minX + 0.11072 * on.width, y: on.minY + 0.64652 * on.height))
            bezier11Path.addCurve(to: CGPoint(x: on.minX + 0.11072 * on.width, y: on.minY + 0.47887 * on.height), controlPoint1: CGPoint(x: on.minX + 0.11072 * on.width, y: on.minY + 0.47887 * on.height), controlPoint2: CGPoint(x: on.minX + 0.11072 * on.width, y: on.minY + 0.47887 * on.height))
            bezier11Path.addLine(to: CGPoint(x: on.minX + 0.14925 * on.width, y: on.minY + 0.47887 * on.height))
            bezier11Path.addCurve(to: CGPoint(x: on.minX + 0.14925 * on.width, y: on.minY + 0.53924 * on.height), controlPoint1: CGPoint(x: on.minX + 0.14925 * on.width, y: on.minY + 0.47887 * on.height), controlPoint2: CGPoint(x: on.minX + 0.14925 * on.width, y: on.minY + 0.47887 * on.height))
            bezier11Path.addCurve(to: CGPoint(x: on.minX + 0.14925 * on.width, y: on.minY + 0.89894 * on.height), controlPoint1: CGPoint(x: on.minX + 0.14925 * on.width, y: on.minY + 0.64652 * on.height), controlPoint2: CGPoint(x: on.minX + 0.14925 * on.width, y: on.minY + 0.64652 * on.height))
            bezier11Path.addLine(to: CGPoint(x: on.minX + 0.11072 * on.width, y: on.minY + 0.89894 * on.height))
            bezier11Path.close()
            MightyMetUI.yellowOrange.setFill()
            bezier11Path.fill()
            ...
            bezier12Path.move(to: CGPoint(x: on.minX + 0.53609 * on.width, y: on.minY + 0.89894 * on.height))
            bezier12Path.addCurve(to: CGPoint(x: on.minX + 0.53609 * on.width, y: on.minY + 0.53138 * on.height), controlPoint1: CGPoint(x: on.minX + 0.53609 * on.width, y: on.minY + 0.63640 * on.height), controlPoint2: CGPoint(x: on.minX + 0.53609 * on.width, y: on.minY + 0.63640 * on.height))
            bezier12Path.addCurve(to: CGPoint(x: on.minX + 0.53609 * on.width, y: on.minY + 0.47887 * on.height), controlPoint1: CGPoint(x: on.minX + 0.53609 * on.width, y: on.minY + 0.47887 * on.height), controlPoint2: CGPoint(x: on.minX + 0.53609 * on.width, y: on.minY + 0.47887 * on.height))
            bezier12Path.addLine(to: CGPoint(x: on.minX + 0.57462 * on.width, y: on.minY + 0.47887 * on.height))
            bezier12Path.addCurve(to: CGPoint(x: on.minX + 0.57462 * on.width, y: on.minY + 0.53138 * on.height), controlPoint1: CGPoint(x: on.minX + 0.57462 * on.width, y: on.minY + 0.47887 * on.height), controlPoint2: CGPoint(x: on.minX + 0.57462 * on.width, y: on.minY + 0.47887 * on.height))
            bezier12Path.addCurve(to: CGPoint(x: on.minX + 0.57462 * on.width, y: on.minY + 0.89894 * on.height), controlPoint1: CGPoint(x: on.minX + 0.57462 * on.width, y: on.minY + 0.63640 * on.height), controlPoint2: CGPoint(x: on.minX + 0.57462 * on.width, y: on.minY + 0.63640 * on.height))
            bezier12Path.addLine(to: CGPoint(x: on.minX + 0.53609 * on.width, y: on.minY + 0.89894 * on.height))
            bezier12Path.close()
            MightyMetUI.yellowOrange.setFill()
            bezier12Path.fill()
            ...
            bezier13Path.move(to: CGPoint(x: on.minX + 0.96147 * on.width, y: on.minY + 0.89894 * on.height))
            bezier13Path.addCurve(to: CGPoint(x: on.minX + 0.96147 * on.width, y: on.minY + 0.53138 * on.height), controlPoint1: CGPoint(x: on.minX + 0.96147 * on.width, y: on.minY + 0.63640 * on.height), controlPoint2: CGPoint(x: on.minX + 0.96147 * on.width, y: on.minY + 0.63640 * on.height))
            bezier13Path.addCurve(to: CGPoint(x: on.minX + 0.96147 * on.width, y: on.minY + 0.47887 * on.height), controlPoint1: CGPoint(x: on.minX + 0.96147 * on.width, y: on.minY + 0.47887 * on.height), controlPoint2: CGPoint(x: on.minX + 0.96147 * on.width, y: on.minY + 0.47887 * on.height))
            bezier13Path.addLine(to: CGPoint(x: on.minX + 1.00000 * on.width, y: on.minY + 0.47887 * on.height))
            bezier13Path.addCurve(to: CGPoint(x: on.minX + 1.00000 * on.width, y: on.minY + 0.53138 * on.height), controlPoint1: CGPoint(x: on.minX + 1.00000 * on.width, y: on.minY + 0.47887 * on.height), controlPoint2: CGPoint(x: on.minX + 1.00000 * on.width, y: on.minY + 0.47887 * on.height))
            bezier13Path.addCurve(to: CGPoint(x: on.minX + 1.00000 * on.width, y: on.minY + 0.89894 * on.height), controlPoint1: CGPoint(x: on.minX + 1.00000 * on.width, y: on.minY + 0.63640 * on.height), controlPoint2: CGPoint(x: on.minX + 1.00000 * on.width, y: on.minY + 0.63640 * on.height))
            bezier13Path.addLine(to: CGPoint(x: on.minX + 0.96147 * on.width, y: on.minY + 0.89894 * on.height))
            bezier13Path.close()
            MightyMetUI.yellowOrange.setFill()
            bezier13Path.fill()
            ...
            oval3Path.move(to: CGPoint(x: on.minX + 0.13948 * on.width, y: on.minY + 0.87680 * on.height))
            oval3Path.addCurve(to: CGPoint(x: on.minX + 0.10164 * on.width, y: on.minY + 0.98411 * on.height), controlPoint1: CGPoint(x: on.minX + 0.15544 * on.width, y: on.minY + 0.91029 * on.height), controlPoint2: CGPoint(x: on.minX + 0.13850 * on.width, y: on.minY + 0.95833 * on.height))
            oval3Path.addCurve(to: CGPoint(x: on.minX + 0.00601 * on.width, y: on.minY + 0.97015 * on.height), controlPoint1: CGPoint(x: on.minX + 0.06478 * on.width, y: on.minY + 1.00989 * on.height), controlPoint2: CGPoint(x: on.minX + 0.02197 * on.width, y: on.minY + 1.00364 * on.height))
            oval3Path.addCurve(to: CGPoint(x: on.minX + 0.04385 * on.width, y: on.minY + 0.86285 * on.height), controlPoint1: CGPoint(x: on.minX + -0.00995 * on.width, y: on.minY + 0.93667 * on.height), controlPoint2: CGPoint(x: on.minX + 0.00699 * on.width, y: on.minY + 0.88862 * on.height))
            oval3Path.addCurve(to: CGPoint(x: on.minX + 0.13948 * on.width, y: on.minY + 0.87680 * on.height), controlPoint1: CGPoint(x: on.minX + 0.08070 * on.width, y: on.minY + 0.83707 * on.height), controlPoint2: CGPoint(x: on.minX + 0.12352 * on.width, y: on.minY + 0.84332 * on.height))
            oval3Path.close()
            MightyMetUI.yellowOrange.setFill()
            oval3Path.fill()
            ...
            oval4Path.move(to: CGPoint(x: on.minX + 0.56331 * on.width, y: on.minY + 0.87680 * on.height))
            oval4Path.addCurve(to: CGPoint(x: on.minX + 0.52548 * on.width, y: on.minY + 0.98411 * on.height), controlPoint1: CGPoint(x: on.minX + 0.57927 * on.width, y: on.minY + 0.91029 * on.height), controlPoint2: CGPoint(x: on.minX + 0.56233 * on.width, y: on.minY + 0.95833 * on.height))
            oval4Path.addCurve(to: CGPoint(x: on.minX + 0.42984 * on.width, y: on.minY + 0.97015 * on.height), controlPoint1: CGPoint(x: on.minX + 0.48862 * on.width, y: on.minY + 1.00989 * on.height), controlPoint2: CGPoint(x: on.minX + 0.44580 * on.width, y: on.minY + 1.00364 * on.height))
            oval4Path.addCurve(to: CGPoint(x: on.minX + 0.46768 * on.width, y: on.minY + 0.86285 * on.height), controlPoint1: CGPoint(x: on.minX + 0.41388 * on.width, y: on.minY + 0.93667 * on.height), controlPoint2: CGPoint(x: on.minX + 0.43082 * on.width, y: on.minY + 0.88862 * on.height))
            oval4Path.addCurve(to: CGPoint(x: on.minX + 0.56331 * on.width, y: on.minY + 0.87680 * on.height), controlPoint1: CGPoint(x: on.minX + 0.50454 * on.width, y: on.minY + 0.83707 * on.height), controlPoint2: CGPoint(x: on.minX + 0.54735 * on.width, y: on.minY + 0.84332 * on.height))
            oval4Path.close()
            MightyMetUI.yellowOrange.setFill()
            oval4Path.fill()
            MightyMetUI.yellowOrange.setStroke()
            ...
            oval6Path.move(to: CGPoint(x: on.minX + 0.98715 * on.width, y: on.minY + 0.87680 * on.height))
            oval6Path.addCurve(to: CGPoint(x: on.minX + 0.94931 * on.width, y: on.minY + 0.98411 * on.height), controlPoint1: CGPoint(x: on.minX + 1.00311 * on.width, y: on.minY + 0.91029 * on.height), controlPoint2: CGPoint(x: on.minX + 0.98617 * on.width, y: on.minY + 0.95833 * on.height))
            oval6Path.addCurve(to: CGPoint(x: on.minX + 0.85368 * on.width, y: on.minY + 0.97015 * on.height), controlPoint1: CGPoint(x: on.minX + 0.91245 * on.width, y: on.minY + 1.00989 * on.height), controlPoint2: CGPoint(x: on.minX + 0.86964 * on.width, y: on.minY + 1.00364 * on.height))
            oval6Path.addCurve(to: CGPoint(x: on.minX + 0.89151 * on.width, y: on.minY + 0.86285 * on.height), controlPoint1: CGPoint(x: on.minX + 0.83772 * on.width, y: on.minY + 0.93667 * on.height), controlPoint2: CGPoint(x: on.minX + 0.85466 * on.width, y: on.minY + 0.88862 * on.height))
            oval6Path.addCurve(to: CGPoint(x: on.minX + 0.98715 * on.width, y: on.minY + 0.87680 * on.height), controlPoint1: CGPoint(x: on.minX + 0.92837 * on.width, y: on.minY + 0.83707 * on.height), controlPoint2: CGPoint(x: on.minX + 0.97119 * on.width, y: on.minY + 0.84332 * on.height))
            oval6Path.close()
            MightyMetUI.yellowOrange.setFill()
            oval6Path.fill()
            MightyMetUI.yellowOrange.setStroke()
    ...
    public dynamic class func draw_16thButton(frame: CGRect = CGRect(x: 0, y: 0, width: 66, height: 62), is16th: Bool = true) {
        ...
        //// Subframes
        let circle: CGRect = CGRect(x: frame.minX + fastFloor(frame.width * 0.13636 + 0.5), y: frame.minY + fastFloor(frame.height * 0.08065 + 0.5), width: fastFloor(frame.width * 0.84848 + 0.5) - fastFloor(frame.width * 0.13636 + 0.5), height: fastFloor(frame.height * 0.83871 + 0.5) - fastFloor(frame.height * 0.08065 + 0.5))
        let off: CGRect = CGRect(x: frame.minX + fastFloor(frame.width * 0.28162 - 0.09) + 0.59, y: frame.minY + fastFloor(frame.height * 0.37097 + 0.5), width: fastFloor(frame.width * 0.67486 - 0.04) - fastFloor(frame.width * 0.28162 - 0.09) - 0.05, height: fastFloor(frame.height * 0.56717 + 0.34) - fastFloor(frame.height * 0.37097 + 0.5) + 0.16)
        let on: CGRect = CGRect(x: frame.minX + fastFloor(frame.width * 0.28162 - 0.09) + 0.59, y: frame.minY + fastFloor(frame.height * 0.37097 + 0.5), width: fastFloor(frame.width * 0.67486 - 0.04) - fastFloor(frame.width * 0.28162 - 0.09) - 0.05, height: fastFloor(frame.height * 0.56717 + 0.34) - fastFloor(frame.height * 0.37097 + 0.5) + 0.16)
        ...
        //// Bezier 4 Drawing
        let bezier4Path = UIBezierPath()
        bezier4Path.move(to: CGPoint(x: off.minX + 0.11224 * off.width, y: off.minY + 0.00000 * off.height))
        bezier4Path.addCurve(to: CGPoint(x: off.minX + 0.88767 * off.width, y: off.minY + 0.00000 * off.height), controlPoint1: CGPoint(x: off.minX + 0.66612 * off.width, y: off.minY + 0.00000 * off.height), controlPoint2: CGPoint(x: off.minX + 0.66612 * off.width, y: off.minY + 0.00000 * off.height))
        bezier4Path.addCurve(to: CGPoint(x: off.minX + 0.99844 * off.width, y: off.minY + 0.00000 * off.height), controlPoint1: CGPoint(x: off.minX + 0.99844 * off.width, y: off.minY + 0.00000 * off.height), controlPoint2: CGPoint(x: off.minX + 0.99844 * off.width, y: off.minY + 0.00000 * off.height))
        bezier4Path.addLine(to: CGPoint(x: off.minX + 0.99844 * off.width, y: off.minY + 0.08221 * off.height))
        bezier4Path.addCurve(to: CGPoint(x: off.minX + 0.88767 * off.width, y: off.minY + 0.08221 * off.height), controlPoint1: CGPoint(x: off.minX + 0.99844 * off.width, y: off.minY + 0.08221 * off.height), controlPoint2: CGPoint(x: off.minX + 0.99844 * off.width, y: off.minY + 0.08221 * off.height))
        bezier4Path.addCurve(to: CGPoint(x: off.minX + 0.11224 * off.width, y: off.minY + 0.08221 * off.height), controlPoint1: CGPoint(x: off.minX + 0.66612 * off.width, y: off.minY + 0.08221 * off.height), controlPoint2: CGPoint(x: off.minX + 0.66612 * off.width, y: off.minY + 0.08221 * off.height))
        bezier4Path.addLine(to: CGPoint(x: off.minX + 0.11224 * off.width, y: off.minY + 0.00000 * off.height))
        bezier4Path.close()
        MightyMetUI.transparent.setFill()
        bezier4Path.fill()
        ...
        //// Bezier 5 Drawing
        let bezier5Path = UIBezierPath()
        bezier5Path.move(to: CGPoint(x: off.minX + 0.11072 * off.width, y: off.minY + 0.82202 * off.height))
        bezier5Path.addCurve(to: CGPoint(x: off.minX + 0.11072 * off.width, y: off.minY + 0.18850 * off.height), controlPoint1: CGPoint(x: off.minX + 0.11072 * off.width, y: off.minY + 0.37744 * off.height), controlPoint2: CGPoint(x: off.minX + 0.11072 * off.width, y: off.minY + 0.37744 * off.height))
        bezier5Path.addCurve(to: CGPoint(x: off.minX + 0.11072 * off.width, y: off.minY + 0.08216 * off.height), controlPoint1: CGPoint(x: off.minX + 0.11072 * off.width, y: off.minY + 0.08216 * off.height), controlPoint2: CGPoint(x: off.minX + 0.11072 * off.width, y: off.minY + 0.08216 * off.height))
        bezier5Path.addLine(to: CGPoint(x: off.minX + 0.14925 * off.width, y: off.minY + 0.08216 * off.height))
        bezier5Path.addCurve(to: CGPoint(x: off.minX + 0.14925 * off.width, y: off.minY + 0.18850 * off.height), controlPoint1: CGPoint(x: off.minX + 0.14925 * off.width, y: off.minY + 0.08216 * off.height), controlPoint2: CGPoint(x: off.minX + 0.14925 * off.width, y: off.minY + 0.08216 * off.height))
        bezier5Path.addCurve(to: CGPoint(x: off.minX + 0.14925 * off.width, y: off.minY + 0.82202 * off.height), controlPoint1: CGPoint(x: off.minX + 0.14925 * off.width, y: off.minY + 0.37744 * off.height), controlPoint2: CGPoint(x: off.minX + 0.14925 * off.width, y: off.minY + 0.37744 * off.height))
        bezier5Path.addLine(to: CGPoint(x: off.minX + 0.11072 * off.width, y: off.minY + 0.82202 * off.height))
        bezier5Path.close()
        MightyMetUI.transparent.setFill()
        bezier5Path.fill()
        ...
        //// Bezier 6 Drawing
        let bezier6Path = UIBezierPath()
        bezier6Path.move(to: CGPoint(x: off.minX + 0.38197 * off.width, y: off.minY + 0.82202 * off.height))
        bezier6Path.addCurve(to: CGPoint(x: off.minX + 0.38197 * off.width, y: off.minY + 0.17465 * off.height), controlPoint1: CGPoint(x: off.minX + 0.38197 * off.width, y: off.minY + 0.35961 * off.height), controlPoint2: CGPoint(x: off.minX + 0.38197 * off.width, y: off.minY + 0.35961 * off.height))
        bezier6Path.addCurve(to: CGPoint(x: off.minX + 0.38197 * off.width, y: off.minY + 0.08216 * off.height), controlPoint1: CGPoint(x: off.minX + 0.38197 * off.width, y: off.minY + 0.08216 * off.height), controlPoint2: CGPoint(x: off.minX + 0.38197 * off.width, y: off.minY + 0.08216 * off.height))
        bezier6Path.addLine(to: CGPoint(x: off.minX + 0.42050 * off.width, y: off.minY + 0.08216 * off.height))
        bezier6Path.addCurve(to: CGPoint(x: off.minX + 0.42050 * off.width, y: off.minY + 0.17465 * off.height), controlPoint1: CGPoint(x: off.minX + 0.42050 * off.width, y: off.minY + 0.08216 * off.height), controlPoint2: CGPoint(x: off.minX + 0.42050 * off.width, y: off.minY + 0.08216 * off.height))
        bezier6Path.addCurve(to: CGPoint(x: off.minX + 0.42050 * off.width, y: off.minY + 0.82202 * off.height), controlPoint1: CGPoint(x: off.minX + 0.42050 * off.width, y: off.minY + 0.35961 * off.height), controlPoint2: CGPoint(x: off.minX + 0.42050 * off.width, y: off.minY + 0.35961 * off.height))
        bezier6Path.addLine(to: CGPoint(x: off.minX + 0.38197 * off.width, y: off.minY + 0.82202 * off.height))
        bezier6Path.close()
        MightyMetUI.transparent.setFill()
        bezier6Path.fill()
        ...
        //// Bezier 7 Drawing
        let bezier7Path = UIBezierPath()
        bezier7Path.move(to: CGPoint(x: off.minX + 0.69176 * off.width, y: off.minY + 0.82202 * off.height))
        bezier7Path.addCurve(to: CGPoint(x: off.minX + 0.69176 * off.width, y: off.minY + 0.17465 * off.height), controlPoint1: CGPoint(x: off.minX + 0.69176 * off.width, y: off.minY + 0.35961 * off.height), controlPoint2: CGPoint(x: off.minX + 0.69176 * off.width, y: off.minY + 0.35961 * off.height))
        bezier7Path.addCurve(to: CGPoint(x: off.minX + 0.69176 * off.width, y: off.minY + 0.08216 * off.height), controlPoint1: CGPoint(x: off.minX + 0.69176 * off.width, y: off.minY + 0.08216 * off.height), controlPoint2: CGPoint(x: off.minX + 0.69176 * off.width, y: off.minY + 0.08216 * off.height))
        bezier7Path.addLine(to: CGPoint(x: off.minX + 0.73029 * off.width, y: off.minY + 0.08216 * off.height))
        bezier7Path.addCurve(to: CGPoint(x: off.minX + 0.73029 * off.width, y: off.minY + 0.17465 * off.height), controlPoint1: CGPoint(x: off.minX + 0.73029 * off.width, y: off.minY + 0.08216 * off.height), controlPoint2: CGPoint(x: off.minX + 0.73029 * off.width, y: off.minY + 0.08216 * off.height))
        bezier7Path.addCurve(to: CGPoint(x: off.minX + 0.73029 * off.width, y: off.minY + 0.82202 * off.height), controlPoint1: CGPoint(x: off.minX + 0.73029 * off.width, y: off.minY + 0.35961 * off.height), controlPoint2: CGPoint(x: off.minX + 0.73029 * off.width, y: off.minY + 0.35961 * off.height))
        bezier7Path.addLine(to: CGPoint(x: off.minX + 0.69176 * off.width, y: off.minY + 0.82202 * off.height))
        bezier7Path.close()
        MightyMetUI.transparent.setFill()
        bezier7Path.fill()
        ...
        //// Oval Drawing
        let ovalPath = UIBezierPath()
        ovalPath.move(to: CGPoint(x: off.minX + 0.13948 * off.width, y: off.minY + 0.78302 * off.height))
        ovalPath.addCurve(to: CGPoint(x: off.minX + 0.10164 * off.width, y: off.minY + 0.97202 * off.height), controlPoint1: CGPoint(x: off.minX + 0.15544 * off.width, y: off.minY + 0.84200 * off.height), controlPoint2: CGPoint(x: off.minX + 0.13850 * off.width, y: off.minY + 0.92662 * off.height))
        ovalPath.addCurve(to: CGPoint(x: off.minX + 0.00601 * off.width, y: off.minY + 0.94743 * off.height), controlPoint1: CGPoint(x: off.minX + 0.06478 * off.width, y: off.minY + 1.01742 * off.height), controlPoint2: CGPoint(x: off.minX + 0.02197 * off.width, y: off.minY + 1.00641 * off.height))
        ovalPath.addCurve(to: CGPoint(x: off.minX + 0.04385 * off.width, y: off.minY + 0.75844 * off.height), controlPoint1: CGPoint(x: off.minX + -0.00995 * off.width, y: off.minY + 0.88846 * off.height), controlPoint2: CGPoint(x: off.minX + 0.00699 * off.width, y: off.minY + 0.80384 * off.height))
        ovalPath.addCurve(to: CGPoint(x: off.minX + 0.13948 * off.width, y: off.minY + 0.78302 * off.height), controlPoint1: CGPoint(x: off.minX + 0.08070 * off.width, y: off.minY + 0.71304 * off.height), controlPoint2: CGPoint(x: off.minX + 0.12352 * off.width, y: off.minY + 0.72404 * off.height))
        ovalPath.close()
        MightyMetUI.transparent.setFill()
        ovalPath.fill()
        ...
        //// Oval 2 Drawing
        let oval2Path = UIBezierPath()
        oval2Path.move(to: CGPoint(x: off.minX + 0.40919 * off.width, y: off.minY + 0.78302 * off.height))
        oval2Path.addCurve(to: CGPoint(x: off.minX + 0.37135 * off.width, y: off.minY + 0.97202 * off.height), controlPoint1: CGPoint(x: off.minX + 0.42515 * off.width, y: off.minY + 0.84200 * off.height), controlPoint2: CGPoint(x: off.minX + 0.40821 * off.width, y: off.minY + 0.92662 * off.height))
        oval2Path.addCurve(to: CGPoint(x: off.minX + 0.27572 * off.width, y: off.minY + 0.94743 * off.height), controlPoint1: CGPoint(x: off.minX + 0.33450 * off.width, y: off.minY + 1.01742 * off.height), controlPoint2: CGPoint(x: off.minX + 0.29168 * off.width, y: off.minY + 1.00641 * off.height))
        oval2Path.addCurve(to: CGPoint(x: off.minX + 0.31356 * off.width, y: off.minY + 0.75844 * off.height), controlPoint1: CGPoint(x: off.minX + 0.25976 * off.width, y: off.minY + 0.88846 * off.height), controlPoint2: CGPoint(x: off.minX + 0.27670 * off.width, y: off.minY + 0.80384 * off.height))
        oval2Path.addCurve(to: CGPoint(x: off.minX + 0.40919 * off.width, y: off.minY + 0.78302 * off.height), controlPoint1: CGPoint(x: off.minX + 0.35042 * off.width, y: off.minY + 0.71304 * off.height), controlPoint2: CGPoint(x: off.minX + 0.39323 * off.width, y: off.minY + 0.72404 * off.height))
        oval2Path.close()
        MightyMetUI.transparent.setFill()
        oval2Path.fill()
        ...
        //// Oval 5 Drawing
        let oval5Path = UIBezierPath()
        oval5Path.move(to: CGPoint(x: off.minX + 0.71744 * off.width, y: off.minY + 0.78302 * off.height))
        oval5Path.addCurve(to: CGPoint(x: off.minX + 0.67960 * off.width, y: off.minY + 0.97202 * off.height), controlPoint1: CGPoint(x: off.minX + 0.73340 * off.width, y: off.minY + 0.84200 * off.height), controlPoint2: CGPoint(x: off.minX + 0.71645 * off.width, y: off.minY + 0.92662 * off.height))
        oval5Path.addCurve(to: CGPoint(x: off.minX + 0.58396 * off.width, y: off.minY + 0.94743 * off.height), controlPoint1: CGPoint(x: off.minX + 0.64274 * off.width, y: off.minY + 1.01742 * off.height), controlPoint2: CGPoint(x: off.minX + 0.59992 * off.width, y: off.minY + 1.00641 * off.height))
        oval5Path.addCurve(to: CGPoint(x: off.minX + 0.62180 * off.width, y: off.minY + 0.75844 * off.height), controlPoint1: CGPoint(x: off.minX + 0.56800 * off.width, y: off.minY + 0.88846 * off.height), controlPoint2: CGPoint(x: off.minX + 0.58494 * off.width, y: off.minY + 0.80384 * off.height))
        oval5Path.addCurve(to: CGPoint(x: off.minX + 0.71744 * off.width, y: off.minY + 0.78302 * off.height), controlPoint1: CGPoint(x: off.minX + 0.65866 * off.width, y: off.minY + 0.71304 * off.height), controlPoint2: CGPoint(x: off.minX + 0.70148 * off.width, y: off.minY + 0.72404 * off.height))
        oval5Path.close()
        MightyMetUI.transparent.setFill()
        oval5Path.fill()
        ...
        //// Bezier 2 Drawing
        let bezier2Path = UIBezierPath()
        bezier2Path.move(to: CGPoint(x: off.minX + 0.11224 * off.width, y: off.minY + 0.16441 * off.height))
        bezier2Path.addCurve(to: CGPoint(x: off.minX + 0.88767 * off.width, y: off.minY + 0.16441 * off.height), controlPoint1: CGPoint(x: off.minX + 0.66612 * off.width, y: off.minY + 0.16441 * off.height), controlPoint2: CGPoint(x: off.minX + 0.66612 * off.width, y: off.minY + 0.16441 * off.height))
        bezier2Path.addCurve(to: CGPoint(x: off.minX + 0.99844 * off.width, y: off.minY + 0.16441 * off.height), controlPoint1: CGPoint(x: off.minX + 0.99844 * off.width, y: off.minY + 0.16441 * off.height), controlPoint2: CGPoint(x: off.minX + 0.99844 * off.width, y: off.minY + 0.16441 * off.height))
        bezier2Path.addLine(to: CGPoint(x: off.minX + 0.99844 * off.width, y: off.minY + 0.24662 * off.height))
        bezier2Path.addCurve(to: CGPoint(x: off.minX + 0.88767 * off.width, y: off.minY + 0.24662 * off.height), controlPoint1: CGPoint(x: off.minX + 0.99844 * off.width, y: off.minY + 0.24662 * off.height), controlPoint2: CGPoint(x: off.minX + 0.99844 * off.width, y: off.minY + 0.24662 * off.height))
        bezier2Path.addCurve(to: CGPoint(x: off.minX + 0.11224 * off.width, y: off.minY + 0.24662 * off.height), controlPoint1: CGPoint(x: off.minX + 0.66612 * off.width, y: off.minY + 0.24662 * off.height), controlPoint2: CGPoint(x: off.minX + 0.66612 * off.width, y: off.minY + 0.24662 * off.height))
        bezier2Path.addLine(to: CGPoint(x: off.minX + 0.11224 * off.width, y: off.minY + 0.16441 * off.height))
        bezier2Path.close()
        MightyMetUI.transparent.setFill()
        bezier2Path.fill()
        ...
        //// Bezier 3 Drawing
        let bezier3Path = UIBezierPath()
        bezier3Path.move(to: CGPoint(x: off.minX + 0.96147 * off.width, y: off.minY + 0.82202 * off.height))
        bezier3Path.addCurve(to: CGPoint(x: off.minX + 0.96147 * off.width, y: off.minY + 0.17465 * off.height), controlPoint1: CGPoint(x: off.minX + 0.96147 * off.width, y: off.minY + 0.35961 * off.height), controlPoint2: CGPoint(x: off.minX + 0.96147 * off.width, y: off.minY + 0.35961 * off.height))
        bezier3Path.addCurve(to: CGPoint(x: off.minX + 0.96147 * off.width, y: off.minY + 0.08216 * off.height), controlPoint1: CGPoint(x: off.minX + 0.96147 * off.width, y: off.minY + 0.08216 * off.height), controlPoint2: CGPoint(x: off.minX + 0.96147 * off.width, y: off.minY + 0.08216 * off.height))
        bezier3Path.addLine(to: CGPoint(x: off.minX + 1.00000 * off.width, y: off.minY + 0.08216 * off.height))
        bezier3Path.addCurve(to: CGPoint(x: off.minX + 1.00000 * off.width, y: off.minY + 0.17465 * off.height), controlPoint1: CGPoint(x: off.minX + 1.00000 * off.width, y: off.minY + 0.08216 * off.height), controlPoint2: CGPoint(x: off.minX + 1.00000 * off.width, y: off.minY + 0.08216 * off.height))
        bezier3Path.addCurve(to: CGPoint(x: off.minX + 1.00000 * off.width, y: off.minY + 0.82202 * off.height), controlPoint1: CGPoint(x: off.minX + 1.00000 * off.width, y: off.minY + 0.35961 * off.height), controlPoint2: CGPoint(x: off.minX + 1.00000 * off.width, y: off.minY + 0.35961 * off.height))
        bezier3Path.addLine(to: CGPoint(x: off.minX + 0.96147 * off.width, y: off.minY + 0.82202 * off.height))
        bezier3Path.close()
        MightyMetUI.transparent.setFill()
        bezier3Path.fill()
        ...
        oval7Path.move(to: CGPoint(x: off.minX + 0.98715 * off.width, y: off.minY + 0.78302 * off.height))
        oval7Path.addCurve(to: CGPoint(x: off.minX + 0.94931 * off.width, y: off.minY + 0.97202 * off.height), controlPoint1: CGPoint(x: off.minX + 1.00311 * off.width, y: off.minY + 0.84200 * off.height), controlPoint2: CGPoint(x: off.minX + 0.98617 * off.width, y: off.minY + 0.92662 * off.height))
        oval7Path.addCurve(to: CGPoint(x: off.minX + 0.85368 * off.width, y: off.minY + 0.94743 * off.height), controlPoint1: CGPoint(x: off.minX + 0.91245 * off.width, y: off.minY + 1.01742 * off.height), controlPoint2: CGPoint(x: off.minX + 0.86964 * off.width, y: off.minY + 1.00641 * off.height))
        oval7Path.addCurve(to: CGPoint(x: off.minX + 0.89151 * off.width, y: off.minY + 0.75844 * off.height), controlPoint1: CGPoint(x: off.minX + 0.83772 * off.width, y: off.minY + 0.88846 * off.height), controlPoint2: CGPoint(x: off.minX + 0.85466 * off.width, y: off.minY + 0.80384 * off.height))
        oval7Path.addCurve(to: CGPoint(x: off.minX + 0.98715 * off.width, y: off.minY + 0.78302 * off.height), controlPoint1: CGPoint(x: off.minX + 0.92837 * off.width, y: off.minY + 0.71304 * off.height), controlPoint2: CGPoint(x: off.minX + 0.97119 * off.width, y: off.minY + 0.72404 * off.height))
        oval7Path.close()
        MightyMetUI.transparent.setFill()
        oval7Path.fill()
        ...
        if (is16th) {
            ...
            //// Bezier 8 Drawing
            let bezier8Path = UIBezierPath()
            bezier8Path.move(to: CGPoint(x: on.minX + 0.11224 * on.width, y: on.minY + 0.00000 * on.height))
            bezier8Path.addCurve(to: CGPoint(x: on.minX + 0.88767 * on.width, y: on.minY + 0.00000 * on.height), controlPoint1: CGPoint(x: on.minX + 0.66612 * on.width, y: on.minY + 0.00000 * on.height), controlPoint2: CGPoint(x: on.minX + 0.66612 * on.width, y: on.minY + 0.00000 * on.height))
            bezier8Path.addCurve(to: CGPoint(x: on.minX + 0.99844 * on.width, y: on.minY + 0.00000 * on.height), controlPoint1: CGPoint(x: on.minX + 0.99844 * on.width, y: on.minY + 0.00000 * on.height), controlPoint2: CGPoint(x: on.minX + 0.99844 * on.width, y: on.minY + 0.00000 * on.height))
            bezier8Path.addLine(to: CGPoint(x: on.minX + 0.99844 * on.width, y: on.minY + 0.08221 * on.height))
            bezier8Path.addCurve(to: CGPoint(x: on.minX + 0.88767 * on.width, y: on.minY + 0.08221 * on.height), controlPoint1: CGPoint(x: on.minX + 0.99844 * on.width, y: on.minY + 0.08221 * on.height), controlPoint2: CGPoint(x: on.minX + 0.99844 * on.width, y: on.minY + 0.08221 * on.height))
            bezier8Path.addCurve(to: CGPoint(x: on.minX + 0.11224 * on.width, y: on.minY + 0.08221 * on.height), controlPoint1: CGPoint(x: on.minX + 0.66612 * on.width, y: on.minY + 0.08221 * on.height), controlPoint2: CGPoint(x: on.minX + 0.66612 * on.width, y: on.minY + 0.08221 * on.height))
            bezier8Path.addLine(to: CGPoint(x: on.minX + 0.11224 * on.width, y: on.minY + 0.00000 * on.height))
            bezier8Path.close()
            MightyMetUI.yellowOrange.setFill()
            bezier8Path.fill()
            ...
            //// Bezier 9 Drawing
            let bezier9Path = UIBezierPath()
            bezier9Path.move(to: CGPoint(x: on.minX + 0.11072 * on.width, y: on.minY + 0.82202 * on.height))
            bezier9Path.addCurve(to: CGPoint(x: on.minX + 0.11072 * on.width, y: on.minY + 0.18850 * on.height), controlPoint1: CGPoint(x: on.minX + 0.11072 * on.width, y: on.minY + 0.37744 * on.height), controlPoint2: CGPoint(x: on.minX + 0.11072 * on.width, y: on.minY + 0.37744 * on.height))
            bezier9Path.addCurve(to: CGPoint(x: on.minX + 0.11072 * on.width, y: on.minY + 0.08216 * on.height), controlPoint1: CGPoint(x: on.minX + 0.11072 * on.width, y: on.minY + 0.08216 * on.height), controlPoint2: CGPoint(x: on.minX + 0.11072 * on.width, y: on.minY + 0.08216 * on.height))
            bezier9Path.addLine(to: CGPoint(x: on.minX + 0.14925 * on.width, y: on.minY + 0.08216 * on.height))
            bezier9Path.addCurve(to: CGPoint(x: on.minX + 0.14925 * on.width, y: on.minY + 0.18850 * on.height), controlPoint1: CGPoint(x: on.minX + 0.14925 * on.width, y: on.minY + 0.08216 * on.height), controlPoint2: CGPoint(x: on.minX + 0.14925 * on.width, y: on.minY + 0.08216 * on.height))
            bezier9Path.addCurve(to: CGPoint(x: on.minX + 0.14925 * on.width, y: on.minY + 0.82202 * on.height), controlPoint1: CGPoint(x: on.minX + 0.14925 * on.width, y: on.minY + 0.37744 * on.height), controlPoint2: CGPoint(x: on.minX + 0.14925 * on.width, y: on.minY + 0.37744 * on.height))
            bezier9Path.addLine(to: CGPoint(x: on.minX + 0.11072 * on.width, y: on.minY + 0.82202 * on.height))
            bezier9Path.close()
            MightyMetUI.yellowOrange.setFill()
            bezier9Path.fill()
            ...
            //// Bezier 10 Drawing
            let bezier10Path = UIBezierPath()
            bezier10Path.move(to: CGPoint(x: on.minX + 0.38197 * on.width, y: on.minY + 0.82202 * on.height))
            bezier10Path.addCurve(to: CGPoint(x: on.minX + 0.38197 * on.width, y: on.minY + 0.17465 * on.height), controlPoint1: CGPoint(x: on.minX + 0.38197 * on.width, y: on.minY + 0.35961 * on.height), controlPoint2: CGPoint(x: on.minX + 0.38197 * on.width, y: on.minY + 0.35961 * on.height))
            bezier10Path.addCurve(to: CGPoint(x: on.minX + 0.38197 * on.width, y: on.minY + 0.08216 * on.height), controlPoint1: CGPoint(x: on.minX + 0.38197 * on.width, y: on.minY + 0.08216 * on.height), controlPoint2: CGPoint(x: on.minX + 0.38197 * on.width, y: on.minY + 0.08216 * on.height))
            bezier10Path.addLine(to: CGPoint(x: on.minX + 0.42050 * on.width, y: on.minY + 0.08216 * on.height))
            bezier10Path.addCurve(to: CGPoint(x: on.minX + 0.42050 * on.width, y: on.minY + 0.17465 * on.height), controlPoint1: CGPoint(x: on.minX + 0.42050 * on.width, y: on.minY + 0.08216 * on.height), controlPoint2: CGPoint(x: on.minX + 0.42050 * on.width, y: on.minY + 0.08216 * on.height))
            bezier10Path.addCurve(to: CGPoint(x: on.minX + 0.42050 * on.width, y: on.minY + 0.82202 * on.height), controlPoint1: CGPoint(x: on.minX + 0.42050 * on.width, y: on.minY + 0.35961 * on.height), controlPoint2: CGPoint(x: on.minX + 0.42050 * on.width, y: on.minY + 0.35961 * on.height))
            bezier10Path.addLine(to: CGPoint(x: on.minX + 0.38197 * on.width, y: on.minY + 0.82202 * on.height))
            bezier10Path.close()
            MightyMetUI.yellowOrange.setFill()
            bezier10Path.fill()
            ...
            //// Bezier 11 Drawing
            let bezier11Path = UIBezierPath()
            bezier11Path.move(to: CGPoint(x: on.minX + 0.69176 * on.width, y: on.minY + 0.82202 * on.height))
            bezier11Path.addCurve(to: CGPoint(x: on.minX + 0.69176 * on.width, y: on.minY + 0.17465 * on.height), controlPoint1: CGPoint(x: on.minX + 0.69176 * on.width, y: on.minY + 0.35961 * on.height), controlPoint2: CGPoint(x: on.minX + 0.69176 * on.width, y: on.minY + 0.35961 * on.height))
            bezier11Path.addCurve(to: CGPoint(x: on.minX + 0.69176 * on.width, y: on.minY + 0.08216 * on.height), controlPoint1: CGPoint(x: on.minX + 0.69176 * on.width, y: on.minY + 0.08216 * on.height), controlPoint2: CGPoint(x: on.minX + 0.69176 * on.width, y: on.minY + 0.08216 * on.height))
            bezier11Path.addLine(to: CGPoint(x: on.minX + 0.73029 * on.width, y: on.minY + 0.08216 * on.height))
            bezier11Path.addCurve(to: CGPoint(x: on.minX + 0.73029 * on.width, y: on.minY + 0.17465 * on.height), controlPoint1: CGPoint(x: on.minX + 0.73029 * on.width, y: on.minY + 0.08216 * on.height), controlPoint2: CGPoint(x: on.minX + 0.73029 * on.width, y: on.minY + 0.08216 * on.height))
            bezier11Path.addCurve(to: CGPoint(x: on.minX + 0.73029 * on.width, y: on.minY + 0.82202 * on.height), controlPoint1: CGPoint(x: on.minX + 0.73029 * on.width, y: on.minY + 0.35961 * on.height), controlPoint2: CGPoint(x: on.minX + 0.73029 * on.width, y: on.minY + 0.35961 * on.height))
            bezier11Path.addLine(to: CGPoint(x: on.minX + 0.69176 * on.width, y: on.minY + 0.82202 * on.height))
            bezier11Path.close()
            MightyMetUI.yellowOrange.setFill()
            bezier11Path.fill()
            ...
            //// Oval 3 Drawing
            let oval3Path = UIBezierPath()
            oval3Path.move(to: CGPoint(x: on.minX + 0.13948 * on.width, y: on.minY + 0.78302 * on.height))
            oval3Path.addCurve(to: CGPoint(x: on.minX + 0.10164 * on.width, y: on.minY + 0.97202 * on.height), controlPoint1: CGPoint(x: on.minX + 0.15544 * on.width, y: on.minY + 0.84200 * on.height), controlPoint2: CGPoint(x: on.minX + 0.13850 * on.width, y: on.minY + 0.92662 * on.height))
            oval3Path.addCurve(to: CGPoint(x: on.minX + 0.00601 * on.width, y: on.minY + 0.94743 * on.height), controlPoint1: CGPoint(x: on.minX + 0.06478 * on.width, y: on.minY + 1.01742 * on.height), controlPoint2: CGPoint(x: on.minX + 0.02197 * on.width, y: on.minY + 1.00641 * on.height))
            oval3Path.addCurve(to: CGPoint(x: on.minX + 0.04385 * on.width, y: on.minY + 0.75844 * on.height), controlPoint1: CGPoint(x: on.minX + -0.00995 * on.width, y: on.minY + 0.88846 * on.height), controlPoint2: CGPoint(x: on.minX + 0.00699 * on.width, y: on.minY + 0.80384 * on.height))
            oval3Path.addCurve(to: CGPoint(x: on.minX + 0.13948 * on.width, y: on.minY + 0.78302 * on.height), controlPoint1: CGPoint(x: on.minX + 0.08070 * on.width, y: on.minY + 0.71304 * on.height), controlPoint2: CGPoint(x: on.minX + 0.12352 * on.width, y: on.minY + 0.72404 * on.height))
            oval3Path.close()
            MightyMetUI.yellowOrange.setFill()
            oval3Path.fill()
            MightyMetUI.yellowOrange.setStroke()
            ...
            //// Oval 4 Drawing
            let oval4Path = UIBezierPath()
            oval4Path.move(to: CGPoint(x: on.minX + 0.40919 * on.width, y: on.minY + 0.78302 * on.height))
            oval4Path.addCurve(to: CGPoint(x: on.minX + 0.37135 * on.width, y: on.minY + 0.97202 * on.height), controlPoint1: CGPoint(x: on.minX + 0.42515 * on.width, y: on.minY + 0.84200 * on.height), controlPoint2: CGPoint(x: on.minX + 0.40821 * on.width, y: on.minY + 0.92662 * on.height))
            oval4Path.addCurve(to: CGPoint(x: on.minX + 0.27572 * on.width, y: on.minY + 0.94743 * on.height), controlPoint1: CGPoint(x: on.minX + 0.33450 * on.width, y: on.minY + 1.01742 * on.height), controlPoint2: CGPoint(x: on.minX + 0.29168 * on.width, y: on.minY + 1.00641 * on.height))
            oval4Path.addCurve(to: CGPoint(x: on.minX + 0.31356 * on.width, y: on.minY + 0.75844 * on.height), controlPoint1: CGPoint(x: on.minX + 0.25976 * on.width, y: on.minY + 0.88846 * on.height), controlPoint2: CGPoint(x: on.minX + 0.27670 * on.width, y: on.minY + 0.80384 * on.height))
            oval4Path.addCurve(to: CGPoint(x: on.minX + 0.40919 * on.width, y: on.minY + 0.78302 * on.height), controlPoint1: CGPoint(x: on.minX + 0.35042 * on.width, y: on.minY + 0.71304 * on.height), controlPoint2: CGPoint(x: on.minX + 0.39323 * on.width, y: on.minY + 0.72404 * on.height))
            oval4Path.close()
            MightyMetUI.yellowOrange.setFill()
            oval4Path.fill()
            MightyMetUI.yellowOrange.setStroke()
            ...
            //// Oval 6 Drawing
            let oval6Path = UIBezierPath()
            oval6Path.move(to: CGPoint(x: on.minX + 0.71744 * on.width, y: on.minY + 0.78302 * on.height))
            oval6Path.addCurve(to: CGPoint(x: on.minX + 0.67960 * on.width, y: on.minY + 0.97202 * on.height), controlPoint1: CGPoint(x: on.minX + 0.73340 * on.width, y: on.minY + 0.84200 * on.height), controlPoint2: CGPoint(x: on.minX + 0.71645 * on.width, y: on.minY + 0.92662 * on.height))
            oval6Path.addCurve(to: CGPoint(x: on.minX + 0.58396 * on.width, y: on.minY + 0.94743 * on.height), controlPoint1: CGPoint(x: on.minX + 0.64274 * on.width, y: on.minY + 1.01742 * on.height), controlPoint2: CGPoint(x: on.minX + 0.59992 * on.width, y: on.minY + 1.00641 * on.height))
            oval6Path.addCurve(to: CGPoint(x: on.minX + 0.62180 * on.width, y: on.minY + 0.75844 * on.height), controlPoint1: CGPoint(x: on.minX + 0.56800 * on.width, y: on.minY + 0.88846 * on.height), controlPoint2: CGPoint(x: on.minX + 0.58494 * on.width, y: on.minY + 0.80384 * on.height))
            oval6Path.addCurve(to: CGPoint(x: on.minX + 0.71744 * on.width, y: on.minY + 0.78302 * on.height), controlPoint1: CGPoint(x: on.minX + 0.65866 * on.width, y: on.minY + 0.71304 * on.height), controlPoint2: CGPoint(x: on.minX + 0.70148 * on.width, y: on.minY + 0.72404 * on.height))
            oval6Path.close()
            MightyMetUI.yellowOrange.setFill()
            oval6Path.fill()
            MightyMetUI.yellowOrange.setStroke()
            ...
            //// Bezier 12 Drawing
            let bezier12Path = UIBezierPath()
            bezier12Path.move(to: CGPoint(x: on.minX + 0.11224 * on.width, y: on.minY + 0.16441 * on.height))
            bezier12Path.addCurve(to: CGPoint(x: on.minX + 0.88767 * on.width, y: on.minY + 0.16441 * on.height), controlPoint1: CGPoint(x: on.minX + 0.66612 * on.width, y: on.minY + 0.16441 * on.height), controlPoint2: CGPoint(x: on.minX + 0.66612 * on.width, y: on.minY + 0.16441 * on.height))
            bezier12Path.addCurve(to: CGPoint(x: on.minX + 0.99844 * on.width, y: on.minY + 0.16441 * on.height), controlPoint1: CGPoint(x: on.minX + 0.99844 * on.width, y: on.minY + 0.16441 * on.height), controlPoint2: CGPoint(x: on.minX + 0.99844 * on.width, y: on.minY + 0.16441 * on.height))
            bezier12Path.addLine(to: CGPoint(x: on.minX + 0.99844 * on.width, y: on.minY + 0.24662 * on.height))
            bezier12Path.addCurve(to: CGPoint(x: on.minX + 0.88767 * on.width, y: on.minY + 0.24662 * on.height), controlPoint1: CGPoint(x: on.minX + 0.99844 * on.width, y: on.minY + 0.24662 * on.height), controlPoint2: CGPoint(x: on.minX + 0.99844 * on.width, y: on.minY + 0.24662 * on.height))
            bezier12Path.addCurve(to: CGPoint(x: on.minX + 0.11224 * on.width, y: on.minY + 0.24662 * on.height), controlPoint1: CGPoint(x: on.minX + 0.66612 * on.width, y: on.minY + 0.24662 * on.height), controlPoint2: CGPoint(x: on.minX + 0.66612 * on.width, y: on.minY + 0.24662 * on.height))
            bezier12Path.addLine(to: CGPoint(x: on.minX + 0.11224 * on.width, y: on.minY + 0.16441 * on.height))
            bezier12Path.close()
            MightyMetUI.yellowOrange.setFill()
            bezier12Path.fill()
            ...
            //// Bezier 13 Drawing
            let bezier13Path = UIBezierPath()
            bezier13Path.move(to: CGPoint(x: on.minX + 0.96147 * on.width, y: on.minY + 0.82202 * on.height))
            bezier13Path.addCurve(to: CGPoint(x: on.minX + 0.96147 * on.width, y: on.minY + 0.17465 * on.height), controlPoint1: CGPoint(x: on.minX + 0.96147 * on.width, y: on.minY + 0.35961 * on.height), controlPoint2: CGPoint(x: on.minX + 0.96147 * on.width, y: on.minY + 0.35961 * on.height))
            bezier13Path.addCurve(to: CGPoint(x: on.minX + 0.96147 * on.width, y: on.minY + 0.08216 * on.height), controlPoint1: CGPoint(x: on.minX + 0.96147 * on.width, y: on.minY + 0.08216 * on.height), controlPoint2: CGPoint(x: on.minX + 0.96147 * on.width, y: on.minY + 0.08216 * on.height))
            bezier13Path.addLine(to: CGPoint(x: on.minX + 1.00000 * on.width, y: on.minY + 0.08216 * on.height))
            bezier13Path.addCurve(to: CGPoint(x: on.minX + 1.00000 * on.width, y: on.minY + 0.17465 * on.height), controlPoint1: CGPoint(x: on.minX + 1.00000 * on.width, y: on.minY + 0.08216 * on.height), controlPoint2: CGPoint(x: on.minX + 1.00000 * on.width, y: on.minY + 0.08216 * on.height))
            bezier13Path.addCurve(to: CGPoint(x: on.minX + 1.00000 * on.width, y: on.minY + 0.82202 * on.height), controlPoint1: CGPoint(x: on.minX + 1.00000 * on.width, y: on.minY + 0.35961 * on.height), controlPoint2: CGPoint(x: on.minX + 1.00000 * on.width, y: on.minY + 0.35961 * on.height))
            bezier13Path.addLine(to: CGPoint(x: on.minX + 0.96147 * on.width, y: on.minY + 0.82202 * on.height))
            bezier13Path.close()
            MightyMetUI.yellowOrange.setFill()
            bezier13Path.fill()
            ...
            oval8Path.move(to: CGPoint(x: on.minX + 0.98715 * on.width, y: on.minY + 0.78302 * on.height))
            oval8Path.addCurve(to: CGPoint(x: on.minX + 0.94931 * on.width, y: on.minY + 0.97202 * on.height), controlPoint1: CGPoint(x: on.minX + 1.00311 * on.width, y: on.minY + 0.84200 * on.height), controlPoint2: CGPoint(x: on.minX + 0.98617 * on.width, y: on.minY + 0.92662 * on.height))
            oval8Path.addCurve(to: CGPoint(x: on.minX + 0.85368 * on.width, y: on.minY + 0.94743 * on.height), controlPoint1: CGPoint(x: on.minX + 0.91245 * on.width, y: on.minY + 1.01742 * on.height), controlPoint2: CGPoint(x: on.minX + 0.86964 * on.width, y: on.minY + 1.00641 * on.height))
            oval8Path.addCurve(to: CGPoint(x: on.minX + 0.89151 * on.width, y: on.minY + 0.75844 * on.height), controlPoint1: CGPoint(x: on.minX + 0.83772 * on.width, y: on.minY + 0.88846 * on.height), controlPoint2: CGPoint(x: on.minX + 0.85466 * on.width, y: on.minY + 0.80384 * on.height))
            oval8Path.addCurve(to: CGPoint(x: on.minX + 0.98715 * on.width, y: on.minY + 0.78302 * on.height), controlPoint1: CGPoint(x: on.minX + 0.92837 * on.width, y: on.minY + 0.71304 * on.height), controlPoint2: CGPoint(x: on.minX + 0.97119 * on.width, y: on.minY + 0.72404 * on.height))
            oval8Path.close()
            MightyMetUI.yellowOrange.setFill()
            oval8Path.fill()
            MightyMetUI.yellowOrange.setStroke()
    ...
    public dynamic class func drawQuarterButton(frame: CGRect = CGRect(x: 0, y: 0, width: 66, height: 62), isQuarter: Bool = true) {
        ...
        //// Subframes
        let circle: CGRect = CGRect(x: frame.minX + fastFloor(frame.width * 0.13636 + 0.5), y: frame.minY + fastFloor(frame.height * 0.09677 + 0.5), width: fastFloor(frame.width * 0.84848 + 0.5) - fastFloor(frame.width * 0.13636 + 0.5), height: fastFloor(frame.height * 0.85484 + 0.5) - fastFloor(frame.height * 0.09677 + 0.5))
        let off: CGRect = CGRect(x: frame.minX + fastFloor(frame.width * 0.45018 - 0.21) + 0.71, y: frame.minY + fastFloor(frame.height * 0.29839) + 0.5, width: fastFloor(frame.width * 0.53391 + 0.26) - fastFloor(frame.width * 0.45018 - 0.21) - 0.47, height: fastFloor(frame.height * 0.67498 - 0.35) - fastFloor(frame.height * 0.29839) + 0.35)
        let on: CGRect = CGRect(x: frame.minX + fastFloor(frame.width * 0.45018 - 0.21) + 0.71, y: frame.minY + fastFloor(frame.height * 0.29839) + 0.5, width: fastFloor(frame.width * 0.53391 + 0.26) - fastFloor(frame.width * 0.45018 - 0.21) - 0.47, height: fastFloor(frame.height * 0.67498 - 0.35) - fastFloor(frame.height * 0.29839) + 0.35)
        ...
        if (isQuarter) {
            //// Bezier 4 Drawing
            let bezier4Path = UIBezierPath()
            bezier4Path.move(to: CGPoint(x: circle.minX + 0.50000 * circle.width, y: circle.minY + 0.08696 * circle.height))
            bezier4Path.addCurve(to: CGPoint(x: circle.minX + 0.27478 * circle.width, y: circle.minY + 0.15370 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.41691 * circle.width, y: circle.minY + 0.08696 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.33956 * circle.width, y: circle.minY + 0.11149 * circle.height))
            bezier4Path.addCurve(to: CGPoint(x: circle.minX + 0.08696 * circle.width, y: circle.minY + 0.50000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.16171 * circle.width, y: circle.minY + 0.22739 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.08696 * circle.width, y: circle.minY + 0.35497 * circle.height))
            bezier4Path.addCurve(to: CGPoint(x: circle.minX + 0.50000 * circle.width, y: circle.minY + 0.91304 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.08696 * circle.width, y: circle.minY + 0.72812 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.27188 * circle.width, y: circle.minY + 0.91304 * circle.height))
            bezier4Path.addCurve(to: CGPoint(x: circle.minX + 0.91304 * circle.width, y: circle.minY + 0.50000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.72812 * circle.width, y: circle.minY + 0.91304 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.91304 * circle.width, y: circle.minY + 0.72812 * circle.height))
            bezier4Path.addCurve(to: CGPoint(x: circle.minX + 0.50000 * circle.width, y: circle.minY + 0.08696 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.91304 * circle.width, y: circle.minY + 0.27188 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.72812 * circle.width, y: circle.minY + 0.08696 * circle.height))
            bezier4Path.close()
            bezier4Path.move(to: CGPoint(x: circle.minX + 1.00000 * circle.width, y: circle.minY + 0.50000 * circle.height))
            bezier4Path.addCurve(to: CGPoint(x: circle.minX + 0.50000 * circle.width, y: circle.minY + 1.00000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 1.00000 * circle.width, y: circle.minY + 0.77614 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.77614 * circle.width, y: circle.minY + 1.00000 * circle.height))
            bezier4Path.addCurve(to: CGPoint(x: circle.minX + 0.00000 * circle.width, y: circle.minY + 0.50000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.22386 * circle.width, y: circle.minY + 1.00000 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.00000 * circle.width, y: circle.minY + 0.77614 * circle.height))
            bezier4Path.addCurve(to: CGPoint(x: circle.minX + 0.19793 * circle.width, y: circle.minY + 0.10153 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.00000 * circle.width, y: circle.minY + 0.33735 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.07766 * circle.width, y: circle.minY + 0.19284 * circle.height))
            bezier4Path.addCurve(to: CGPoint(x: circle.minX + 0.50000 * circle.width, y: circle.minY + 0.00000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.28184 * circle.width, y: circle.minY + 0.03781 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.38651 * circle.width, y: circle.minY + 0.00000 * circle.height))
            bezier4Path.addCurve(to: CGPoint(x: circle.minX + 1.00000 * circle.width, y: circle.minY + 0.50000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.77614 * circle.width, y: circle.minY + 0.00000 * circle.height), controlPoint2: CGPoint(x: circle.minX + 1.00000 * circle.width, y: circle.minY + 0.22386 * circle.height))
            bezier4Path.close()
            MightyMetUI.yellowOrange.setFill()
            bezier4Path.fill()
        }
        ...
        //// Bezier 3 Drawing
        let bezier3Path = UIBezierPath()
        bezier3Path.move(to: CGPoint(x: off.minX + 0.76024 * off.width, y: off.minY + 0.00000 * off.height))
        bezier3Path.addLine(to: CGPoint(x: off.minX + 0.76024 * off.width, y: off.minY + 0.82964 * off.height))
        ...
        //// Oval Drawing
        let ovalPath = UIBezierPath()
        ovalPath.move(to: CGPoint(x: off.minX + 0.95541 * off.width, y: off.minY + 0.83283 * off.height))
        ovalPath.addCurve(to: CGPoint(x: off.minX + 0.70610 * off.width, y: off.minY + 0.97955 * off.height), controlPoint1: CGPoint(x: off.minX + 1.06924 * off.width, y: off.minY + 0.87949 * off.height), controlPoint2: CGPoint(x: off.minX + 0.95762 * off.width, y: off.minY + 0.94518 * off.height))
        ovalPath.addCurve(to: CGPoint(x: off.minX + 0.04459 * off.width, y: off.minY + 0.95729 * off.height), controlPoint1: CGPoint(x: off.minX + 0.45459 * off.width, y: off.minY + 1.01392 * off.height), controlPoint2: CGPoint(x: off.minX + 0.15842 * off.width, y: off.minY + 1.00395 * off.height))
        ovalPath.addCurve(to: CGPoint(x: off.minX + 0.29390 * off.width, y: off.minY + 0.81057 * off.height), controlPoint1: CGPoint(x: off.minX + -0.06924 * off.width, y: off.minY + 0.91063 * off.height), controlPoint2: CGPoint(x: off.minX + 0.04238 * off.width, y: off.minY + 0.84494 * off.height))
        ovalPath.addCurve(to: CGPoint(x: off.minX + 0.95541 * off.width, y: off.minY + 0.83283 * off.height), controlPoint1: CGPoint(x: off.minX + 0.54541 * off.width, y: off.minY + 0.77620 * off.height), controlPoint2: CGPoint(x: off.minX + 0.84158 * off.width, y: off.minY + 0.78617 * off.height))
        ovalPath.close()
        MightyMetUI.transparent.setFill()
        ovalPath.fill()
        ...
        if (isQuarter) {
            ...
            //// Bezier 2 Drawing
            let bezier2Path = UIBezierPath()
            bezier2Path.move(to: CGPoint(x: on.minX + 0.76024 * on.width, y: on.minY + 0.00000 * on.height))
            bezier2Path.addLine(to: CGPoint(x: on.minX + 0.76024 * on.width, y: on.minY + 0.82964 * on.height))
            context.saveGState()
            context.setShadow(offset: shadow.shadowOffset, blur: shadow.shadowBlurRadius, color: (shadow.shadowColor as! UIColor).cgColor)
            MightyMetUI.yellowOrange.setStroke()
            bezier2Path.lineWidth = 1
            ...
            //// Oval 2 Drawing
            let oval2Path = UIBezierPath()
            oval2Path.move(to: CGPoint(x: on.minX + 0.95541 * on.width, y: on.minY + 0.83283 * on.height))
            oval2Path.addCurve(to: CGPoint(x: on.minX + 0.70610 * on.width, y: on.minY + 0.97955 * on.height), controlPoint1: CGPoint(x: on.minX + 1.06924 * on.width, y: on.minY + 0.87949 * on.height), controlPoint2: CGPoint(x: on.minX + 0.95762 * on.width, y: on.minY + 0.94518 * on.height))
            oval2Path.addCurve(to: CGPoint(x: on.minX + 0.04459 * on.width, y: on.minY + 0.95729 * on.height), controlPoint1: CGPoint(x: on.minX + 0.45459 * on.width, y: on.minY + 1.01392 * on.height), controlPoint2: CGPoint(x: on.minX + 0.15842 * on.width, y: on.minY + 1.00395 * on.height))
            oval2Path.addCurve(to: CGPoint(x: on.minX + 0.29390 * on.width, y: on.minY + 0.81057 * on.height), controlPoint1: CGPoint(x: on.minX + -0.06924 * on.width, y: on.minY + 0.91063 * on.height), controlPoint2: CGPoint(x: on.minX + 0.04238 * on.width, y: on.minY + 0.84494 * on.height))
            oval2Path.addCurve(to: CGPoint(x: on.minX + 0.95541 * on.width, y: on.minY + 0.83283 * on.height), controlPoint1: CGPoint(x: on.minX + 0.54541 * on.width, y: on.minY + 0.77620 * on.height), controlPoint2: CGPoint(x: on.minX + 0.84158 * on.width, y: on.minY + 0.78617 * on.height))
            oval2Path.close()
            MightyMetUI.yellowOrange.setFill()
            oval2Path.fill()
    ...
    public dynamic class func draw_8thButton(frame: CGRect = CGRect(x: 0, y: 0, width: 66, height: 62), is8th: Bool = true) {
        ...
        //// Subframes
        let circle: CGRect = CGRect(x: frame.minX + fastFloor(frame.width * 0.13636 + 0.5), y: frame.minY + fastFloor(frame.height * 0.09677 + 0.5), width: fastFloor(frame.width * 0.84848 + 0.5) - fastFloor(frame.width * 0.13636 + 0.5), height: fastFloor(frame.height * 0.85484 + 0.5) - fastFloor(frame.height * 0.09677 + 0.5))
        let off: CGRect = CGRect(x: frame.minX + fastFloor(frame.width * 0.38768 - 0.09) + 0.59, y: frame.minY + fastFloor(frame.height * 0.37097 - 0.5) + 1, width: fastFloor(frame.width * 0.61364) - fastFloor(frame.width * 0.38768 - 0.09) - 0.09, height: fastFloor(frame.height * 0.61556 + 0.34) - fastFloor(frame.height * 0.37097 - 0.5) - 0.84)
        let on: CGRect = CGRect(x: frame.minX + fastFloor(frame.width * 0.38768 - 0.09) + 0.59, y: frame.minY + fastFloor(frame.height * 0.37097 - 0.5) + 1, width: fastFloor(frame.width * 0.61364) - fastFloor(frame.width * 0.38768 - 0.09) - 0.09, height: fastFloor(frame.height * 0.61556 + 0.34) - fastFloor(frame.height * 0.37097 - 0.5) - 0.84)
        ...
        if (is8th) {
            //// Bezier 8 Drawing
            let bezier8Path = UIBezierPath()
            bezier8Path.move(to: CGPoint(x: circle.minX + 0.50000 * circle.width, y: circle.minY + 0.08696 * circle.height))
            bezier8Path.addCurve(to: CGPoint(x: circle.minX + 0.27478 * circle.width, y: circle.minY + 0.15370 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.41691 * circle.width, y: circle.minY + 0.08696 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.33956 * circle.width, y: circle.minY + 0.11149 * circle.height))
            bezier8Path.addCurve(to: CGPoint(x: circle.minX + 0.08696 * circle.width, y: circle.minY + 0.50000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.16171 * circle.width, y: circle.minY + 0.22739 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.08696 * circle.width, y: circle.minY + 0.35497 * circle.height))
            bezier8Path.addCurve(to: CGPoint(x: circle.minX + 0.50000 * circle.width, y: circle.minY + 0.91304 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.08696 * circle.width, y: circle.minY + 0.72812 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.27188 * circle.width, y: circle.minY + 0.91304 * circle.height))
            bezier8Path.addCurve(to: CGPoint(x: circle.minX + 0.91304 * circle.width, y: circle.minY + 0.50000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.72812 * circle.width, y: circle.minY + 0.91304 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.91304 * circle.width, y: circle.minY + 0.72812 * circle.height))
            bezier8Path.addCurve(to: CGPoint(x: circle.minX + 0.50000 * circle.width, y: circle.minY + 0.08696 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.91304 * circle.width, y: circle.minY + 0.27188 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.72812 * circle.width, y: circle.minY + 0.08696 * circle.height))
            bezier8Path.close()
            bezier8Path.move(to: CGPoint(x: circle.minX + 1.00000 * circle.width, y: circle.minY + 0.50000 * circle.height))
            bezier8Path.addCurve(to: CGPoint(x: circle.minX + 0.50000 * circle.width, y: circle.minY + 1.00000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 1.00000 * circle.width, y: circle.minY + 0.77614 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.77614 * circle.width, y: circle.minY + 1.00000 * circle.height))
            bezier8Path.addCurve(to: CGPoint(x: circle.minX + 0.00000 * circle.width, y: circle.minY + 0.50000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.22386 * circle.width, y: circle.minY + 1.00000 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.00000 * circle.width, y: circle.minY + 0.77614 * circle.height))
            bezier8Path.addCurve(to: CGPoint(x: circle.minX + 0.19793 * circle.width, y: circle.minY + 0.10153 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.00000 * circle.width, y: circle.minY + 0.33735 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.07766 * circle.width, y: circle.minY + 0.19284 * circle.height))
            bezier8Path.addCurve(to: CGPoint(x: circle.minX + 0.50000 * circle.width, y: circle.minY + 0.00000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.28184 * circle.width, y: circle.minY + 0.03781 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.38651 * circle.width, y: circle.minY + 0.00000 * circle.height))
            bezier8Path.addCurve(to: CGPoint(x: circle.minX + 1.00000 * circle.width, y: circle.minY + 0.50000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.77614 * circle.width, y: circle.minY + 0.00000 * circle.height), controlPoint2: CGPoint(x: circle.minX + 1.00000 * circle.width, y: circle.minY + 0.22386 * circle.height))
            bezier8Path.close()
            MightyMetUI.yellowOrange.setFill()
            bezier8Path.fill()
        }
        ...
        //// Bezier 4 Drawing
        let bezier4Path = UIBezierPath()
        bezier4Path.move(to: CGPoint(x: off.minX + 0.19534 * off.width, y: off.minY + 0.00000 * off.height))
        bezier4Path.addCurve(to: CGPoint(x: off.minX + 0.89942 * off.width, y: off.minY + 0.00000 * off.height), controlPoint1: CGPoint(x: off.minX + 0.69825 * off.width, y: off.minY + 0.00000 * off.height), controlPoint2: CGPoint(x: off.minX + 0.69825 * off.width, y: off.minY + 0.00000 * off.height))
        bezier4Path.addCurve(to: CGPoint(x: off.minX + 1.00000 * off.width, y: off.minY + 0.00000 * off.height), controlPoint1: CGPoint(x: off.minX + 1.00000 * off.width, y: off.minY + 0.00000 * off.height), controlPoint2: CGPoint(x: off.minX + 1.00000 * off.width, y: off.minY + 0.00000 * off.height))
        bezier4Path.addLine(to: CGPoint(x: off.minX + 1.00000 * off.width, y: off.minY + 0.06594 * off.height))
        bezier4Path.addCurve(to: CGPoint(x: off.minX + 0.89942 * off.width, y: off.minY + 0.06594 * off.height), controlPoint1: CGPoint(x: off.minX + 1.00000 * off.width, y: off.minY + 0.06594 * off.height), controlPoint2: CGPoint(x: off.minX + 1.00000 * off.width, y: off.minY + 0.06594 * off.height))
        bezier4Path.addCurve(to: CGPoint(x: off.minX + 0.19534 * off.width, y: off.minY + 0.06594 * off.height), controlPoint1: CGPoint(x: off.minX + 0.69825 * off.width, y: off.minY + 0.06594 * off.height), controlPoint2: CGPoint(x: off.minX + 0.69825 * off.width, y: off.minY + 0.06594 * off.height))
        bezier4Path.addLine(to: CGPoint(x: off.minX + 0.19534 * off.width, y: off.minY + 0.00000 * off.height))
        bezier4Path.close()
        MightyMetUI.transparent.setFill()
        bezier4Path.fill()
        ...
        //// Bezier 5 Drawing
        let bezier5Path = UIBezierPath()
        bezier5Path.move(to: CGPoint(x: off.minX + 0.19262 * off.width, y: off.minY + 0.82429 * off.height))
        bezier5Path.addCurve(to: CGPoint(x: off.minX + 0.19262 * off.width, y: off.minY + 0.16068 * off.height), controlPoint1: CGPoint(x: off.minX + 0.19262 * off.width, y: off.minY + 0.35026 * off.height), controlPoint2: CGPoint(x: off.minX + 0.19262 * off.width, y: off.minY + 0.35026 * off.height))
        bezier5Path.addCurve(to: CGPoint(x: off.minX + 0.19262 * off.width, y: off.minY + 0.06591 * off.height), controlPoint1: CGPoint(x: off.minX + 0.19262 * off.width, y: off.minY + 0.06591 * off.height), controlPoint2: CGPoint(x: off.minX + 0.19262 * off.width, y: off.minY + 0.06591 * off.height))
        bezier5Path.addLine(to: CGPoint(x: off.minX + 0.25967 * off.width, y: off.minY + 0.06591 * off.height))
        bezier5Path.addCurve(to: CGPoint(x: off.minX + 0.25967 * off.width, y: off.minY + 0.16068 * off.height), controlPoint1: CGPoint(x: off.minX + 0.25967 * off.width, y: off.minY + 0.06591 * off.height), controlPoint2: CGPoint(x: off.minX + 0.25967 * off.width, y: off.minY + 0.06591 * off.height))
        bezier5Path.addCurve(to: CGPoint(x: off.minX + 0.25967 * off.width, y: off.minY + 0.82429 * off.height), controlPoint1: CGPoint(x: off.minX + 0.25967 * off.width, y: off.minY + 0.35026 * off.height), controlPoint2: CGPoint(x: off.minX + 0.25967 * off.width, y: off.minY + 0.35026 * off.height))
        bezier5Path.addLine(to: CGPoint(x: off.minX + 0.19262 * off.width, y: off.minY + 0.82429 * off.height))
        bezier5Path.close()
        MightyMetUI.transparent.setFill()
        bezier5Path.fill()
        ...
        //// Bezier 6 Drawing
        let bezier6Path = UIBezierPath()
        bezier6Path.move(to: CGPoint(x: off.minX + 0.92716 * off.width, y: off.minY + 0.82429 * off.height))
        bezier6Path.addCurve(to: CGPoint(x: off.minX + 0.92716 * off.width, y: off.minY + 0.16081 * off.height), controlPoint1: CGPoint(x: off.minX + 0.92716 * off.width, y: off.minY + 0.35044 * off.height), controlPoint2: CGPoint(x: off.minX + 0.92716 * off.width, y: off.minY + 0.35044 * off.height))
        bezier6Path.addCurve(to: CGPoint(x: off.minX + 0.92716 * off.width, y: off.minY + 0.06591 * off.height), controlPoint1: CGPoint(x: off.minX + 0.92716 * off.width, y: off.minY + 0.06591 * off.height), controlPoint2: CGPoint(x: off.minX + 0.92716 * off.width, y: off.minY + 0.06591 * off.height))
        bezier6Path.addLine(to: CGPoint(x: off.minX + 0.99422 * off.width, y: off.minY + 0.06591 * off.height))
        bezier6Path.addCurve(to: CGPoint(x: off.minX + 0.99422 * off.width, y: off.minY + 0.16081 * off.height), controlPoint1: CGPoint(x: off.minX + 0.99422 * off.width, y: off.minY + 0.06591 * off.height), controlPoint2: CGPoint(x: off.minX + 0.99422 * off.width, y: off.minY + 0.06591 * off.height))
        bezier6Path.addCurve(to: CGPoint(x: off.minX + 0.99422 * off.width, y: off.minY + 0.82429 * off.height), controlPoint1: CGPoint(x: off.minX + 0.99422 * off.width, y: off.minY + 0.35044 * off.height), controlPoint2: CGPoint(x: off.minX + 0.99422 * off.width, y: off.minY + 0.35044 * off.height))
        bezier6Path.addLine(to: CGPoint(x: off.minX + 0.92716 * off.width, y: off.minY + 0.82429 * off.height))
        bezier6Path.close()
        MightyMetUI.transparent.setFill()
        bezier6Path.fill()
        ...
        //// Oval Drawing
        let ovalPath = UIBezierPath()
        ovalPath.move(to: CGPoint(x: off.minX + 0.24274 * off.width, y: off.minY + 0.82595 * off.height))
        ovalPath.addCurve(to: CGPoint(x: off.minX + 0.17689 * off.width, y: off.minY + 0.97755 * off.height), controlPoint1: CGPoint(x: off.minX + 0.27051 * off.width, y: off.minY + 0.87326 * off.height), controlPoint2: CGPoint(x: off.minX + 0.24103 * off.width, y: off.minY + 0.94113 * off.height))
        ovalPath.addCurve(to: CGPoint(x: off.minX + 0.01045 * off.width, y: off.minY + 0.95783 * off.height), controlPoint1: CGPoint(x: off.minX + 0.11274 * off.width, y: off.minY + 1.01397 * off.height), controlPoint2: CGPoint(x: off.minX + 0.03823 * off.width, y: off.minY + 1.00514 * off.height))
        ovalPath.addCurve(to: CGPoint(x: off.minX + 0.07630 * off.width, y: off.minY + 0.80623 * off.height), controlPoint1: CGPoint(x: off.minX + -0.01732 * off.width, y: off.minY + 0.91052 * off.height), controlPoint2: CGPoint(x: off.minX + 0.01216 * off.width, y: off.minY + 0.84265 * off.height))
        ovalPath.addCurve(to: CGPoint(x: off.minX + 0.24274 * off.width, y: off.minY + 0.82595 * off.height), controlPoint1: CGPoint(x: off.minX + 0.14045 * off.width, y: off.minY + 0.76981 * off.height), controlPoint2: CGPoint(x: off.minX + 0.21496 * off.width, y: off.minY + 0.77864 * off.height))
        ovalPath.close()
        MightyMetUI.transparent.setFill()
        ovalPath.fill()
        ...
        //// Oval 2 Drawing
        let oval2Path = UIBezierPath()
        oval2Path.move(to: CGPoint(x: off.minX + 0.98035 * off.width, y: off.minY + 0.82595 * off.height))
        oval2Path.addCurve(to: CGPoint(x: off.minX + 0.91450 * off.width, y: off.minY + 0.97755 * off.height), controlPoint1: CGPoint(x: off.minX + 1.00812 * off.width, y: off.minY + 0.87326 * off.height), controlPoint2: CGPoint(x: off.minX + 0.97864 * off.width, y: off.minY + 0.94113 * off.height))
        oval2Path.addCurve(to: CGPoint(x: off.minX + 0.74806 * off.width, y: off.minY + 0.95783 * off.height), controlPoint1: CGPoint(x: off.minX + 0.85035 * off.width, y: off.minY + 1.01397 * off.height), controlPoint2: CGPoint(x: off.minX + 0.77584 * off.width, y: off.minY + 1.00514 * off.height))
        oval2Path.addCurve(to: CGPoint(x: off.minX + 0.81391 * off.width, y: off.minY + 0.80623 * off.height), controlPoint1: CGPoint(x: off.minX + 0.72029 * off.width, y: off.minY + 0.91052 * off.height), controlPoint2: CGPoint(x: off.minX + 0.74977 * off.width, y: off.minY + 0.84265 * off.height))
        oval2Path.addCurve(to: CGPoint(x: off.minX + 0.98035 * off.width, y: off.minY + 0.82595 * off.height), controlPoint1: CGPoint(x: off.minX + 0.87806 * off.width, y: off.minY + 0.76981 * off.height), controlPoint2: CGPoint(x: off.minX + 0.95257 * off.width, y: off.minY + 0.77864 * off.height))
        oval2Path.close()
        MightyMetUI.transparent.setFill()
        oval2Path.fill()
        ...
        if (is8th) {
            ...
            //// Bezier 2 Drawing
            let bezier2Path = UIBezierPath()
            bezier2Path.move(to: CGPoint(x: on.minX + 0.19534 * on.width, y: on.minY + 0.00000 * on.height))
            bezier2Path.addCurve(to: CGPoint(x: on.minX + 0.89942 * on.width, y: on.minY + 0.00000 * on.height), controlPoint1: CGPoint(x: on.minX + 0.69825 * on.width, y: on.minY + 0.00000 * on.height), controlPoint2: CGPoint(x: on.minX + 0.69825 * on.width, y: on.minY + 0.00000 * on.height))
            bezier2Path.addCurve(to: CGPoint(x: on.minX + 1.00000 * on.width, y: on.minY + 0.00000 * on.height), controlPoint1: CGPoint(x: on.minX + 1.00000 * on.width, y: on.minY + 0.00000 * on.height), controlPoint2: CGPoint(x: on.minX + 1.00000 * on.width, y: on.minY + 0.00000 * on.height))
            bezier2Path.addLine(to: CGPoint(x: on.minX + 1.00000 * on.width, y: on.minY + 0.06594 * on.height))
            bezier2Path.addCurve(to: CGPoint(x: on.minX + 0.89942 * on.width, y: on.minY + 0.06594 * on.height), controlPoint1: CGPoint(x: on.minX + 1.00000 * on.width, y: on.minY + 0.06594 * on.height), controlPoint2: CGPoint(x: on.minX + 1.00000 * on.width, y: on.minY + 0.06594 * on.height))
            bezier2Path.addCurve(to: CGPoint(x: on.minX + 0.19534 * on.width, y: on.minY + 0.06594 * on.height), controlPoint1: CGPoint(x: on.minX + 0.69825 * on.width, y: on.minY + 0.06594 * on.height), controlPoint2: CGPoint(x: on.minX + 0.69825 * on.width, y: on.minY + 0.06594 * on.height))
            bezier2Path.addLine(to: CGPoint(x: on.minX + 0.19534 * on.width, y: on.minY + 0.00000 * on.height))
            bezier2Path.close()
            MightyMetUI.yellowOrange.setFill()
            bezier2Path.fill()
            ...
            //// Bezier 3 Drawing
            let bezier3Path = UIBezierPath()
            bezier3Path.move(to: CGPoint(x: on.minX + 0.19262 * on.width, y: on.minY + 0.82429 * on.height))
            bezier3Path.addCurve(to: CGPoint(x: on.minX + 0.19262 * on.width, y: on.minY + 0.16068 * on.height), controlPoint1: CGPoint(x: on.minX + 0.19262 * on.width, y: on.minY + 0.35026 * on.height), controlPoint2: CGPoint(x: on.minX + 0.19262 * on.width, y: on.minY + 0.35026 * on.height))
            bezier3Path.addCurve(to: CGPoint(x: on.minX + 0.19262 * on.width, y: on.minY + 0.06591 * on.height), controlPoint1: CGPoint(x: on.minX + 0.19262 * on.width, y: on.minY + 0.06591 * on.height), controlPoint2: CGPoint(x: on.minX + 0.19262 * on.width, y: on.minY + 0.06591 * on.height))
            bezier3Path.addLine(to: CGPoint(x: on.minX + 0.25967 * on.width, y: on.minY + 0.06591 * on.height))
            bezier3Path.addCurve(to: CGPoint(x: on.minX + 0.25967 * on.width, y: on.minY + 0.16068 * on.height), controlPoint1: CGPoint(x: on.minX + 0.25967 * on.width, y: on.minY + 0.06591 * on.height), controlPoint2: CGPoint(x: on.minX + 0.25967 * on.width, y: on.minY + 0.06591 * on.height))
            bezier3Path.addCurve(to: CGPoint(x: on.minX + 0.25967 * on.width, y: on.minY + 0.82429 * on.height), controlPoint1: CGPoint(x: on.minX + 0.25967 * on.width, y: on.minY + 0.35026 * on.height), controlPoint2: CGPoint(x: on.minX + 0.25967 * on.width, y: on.minY + 0.35026 * on.height))
            bezier3Path.addLine(to: CGPoint(x: on.minX + 0.19262 * on.width, y: on.minY + 0.82429 * on.height))
            bezier3Path.close()
            MightyMetUI.yellowOrange.setFill()
            bezier3Path.fill()
            ...
            //// Bezier 7 Drawing
            let bezier7Path = UIBezierPath()
            bezier7Path.move(to: CGPoint(x: on.minX + 0.92716 * on.width, y: on.minY + 0.82429 * on.height))
            bezier7Path.addCurve(to: CGPoint(x: on.minX + 0.92716 * on.width, y: on.minY + 0.16081 * on.height), controlPoint1: CGPoint(x: on.minX + 0.92716 * on.width, y: on.minY + 0.35044 * on.height), controlPoint2: CGPoint(x: on.minX + 0.92716 * on.width, y: on.minY + 0.35044 * on.height))
            bezier7Path.addCurve(to: CGPoint(x: on.minX + 0.92716 * on.width, y: on.minY + 0.06591 * on.height), controlPoint1: CGPoint(x: on.minX + 0.92716 * on.width, y: on.minY + 0.06591 * on.height), controlPoint2: CGPoint(x: on.minX + 0.92716 * on.width, y: on.minY + 0.06591 * on.height))
            bezier7Path.addLine(to: CGPoint(x: on.minX + 0.99422 * on.width, y: on.minY + 0.06591 * on.height))
            bezier7Path.addCurve(to: CGPoint(x: on.minX + 0.99422 * on.width, y: on.minY + 0.16081 * on.height), controlPoint1: CGPoint(x: on.minX + 0.99422 * on.width, y: on.minY + 0.06591 * on.height), controlPoint2: CGPoint(x: on.minX + 0.99422 * on.width, y: on.minY + 0.06591 * on.height))
            bezier7Path.addCurve(to: CGPoint(x: on.minX + 0.99422 * on.width, y: on.minY + 0.82429 * on.height), controlPoint1: CGPoint(x: on.minX + 0.99422 * on.width, y: on.minY + 0.35044 * on.height), controlPoint2: CGPoint(x: on.minX + 0.99422 * on.width, y: on.minY + 0.35044 * on.height))
            bezier7Path.addLine(to: CGPoint(x: on.minX + 0.92716 * on.width, y: on.minY + 0.82429 * on.height))
            bezier7Path.close()
            MightyMetUI.yellowOrange.setFill()
            bezier7Path.fill()
            ...
            //// Oval 3 Drawing
            let oval3Path = UIBezierPath()
            oval3Path.move(to: CGPoint(x: on.minX + 0.24274 * on.width, y: on.minY + 0.82595 * on.height))
            oval3Path.addCurve(to: CGPoint(x: on.minX + 0.17689 * on.width, y: on.minY + 0.97755 * on.height), controlPoint1: CGPoint(x: on.minX + 0.27051 * on.width, y: on.minY + 0.87326 * on.height), controlPoint2: CGPoint(x: on.minX + 0.24103 * on.width, y: on.minY + 0.94113 * on.height))
            oval3Path.addCurve(to: CGPoint(x: on.minX + 0.01045 * on.width, y: on.minY + 0.95783 * on.height), controlPoint1: CGPoint(x: on.minX + 0.11274 * on.width, y: on.minY + 1.01397 * on.height), controlPoint2: CGPoint(x: on.minX + 0.03823 * on.width, y: on.minY + 1.00514 * on.height))
            oval3Path.addCurve(to: CGPoint(x: on.minX + 0.07630 * on.width, y: on.minY + 0.80623 * on.height), controlPoint1: CGPoint(x: on.minX + -0.01732 * on.width, y: on.minY + 0.91052 * on.height), controlPoint2: CGPoint(x: on.minX + 0.01216 * on.width, y: on.minY + 0.84265 * on.height))
            oval3Path.addCurve(to: CGPoint(x: on.minX + 0.24274 * on.width, y: on.minY + 0.82595 * on.height), controlPoint1: CGPoint(x: on.minX + 0.14045 * on.width, y: on.minY + 0.76981 * on.height), controlPoint2: CGPoint(x: on.minX + 0.21496 * on.width, y: on.minY + 0.77864 * on.height))
            oval3Path.close()
            MightyMetUI.yellowOrange.setFill()
            oval3Path.fill()
            ...
            //// Oval 4 Drawing
            let oval4Path = UIBezierPath()
            oval4Path.move(to: CGPoint(x: on.minX + 0.98035 * on.width, y: on.minY + 0.82595 * on.height))
            oval4Path.addCurve(to: CGPoint(x: on.minX + 0.91450 * on.width, y: on.minY + 0.97755 * on.height), controlPoint1: CGPoint(x: on.minX + 1.00812 * on.width, y: on.minY + 0.87326 * on.height), controlPoint2: CGPoint(x: on.minX + 0.97864 * on.width, y: on.minY + 0.94113 * on.height))
            oval4Path.addCurve(to: CGPoint(x: on.minX + 0.74806 * on.width, y: on.minY + 0.95783 * on.height), controlPoint1: CGPoint(x: on.minX + 0.85035 * on.width, y: on.minY + 1.01397 * on.height), controlPoint2: CGPoint(x: on.minX + 0.77584 * on.width, y: on.minY + 1.00514 * on.height))
            oval4Path.addCurve(to: CGPoint(x: on.minX + 0.81391 * on.width, y: on.minY + 0.80623 * on.height), controlPoint1: CGPoint(x: on.minX + 0.72029 * on.width, y: on.minY + 0.91052 * on.height), controlPoint2: CGPoint(x: on.minX + 0.74977 * on.width, y: on.minY + 0.84265 * on.height))
            oval4Path.addCurve(to: CGPoint(x: on.minX + 0.98035 * on.width, y: on.minY + 0.82595 * on.height), controlPoint1: CGPoint(x: on.minX + 0.87806 * on.width, y: on.minY + 0.76981 * on.height), controlPoint2: CGPoint(x: on.minX + 0.95257 * on.width, y: on.minY + 0.77864 * on.height))
            oval4Path.close()
            MightyMetUI.yellowOrange.setFill()
            oval4Path.fill()
    ...
    public dynamic class func drawTapTempo(frame: CGRect = CGRect(x: 0, y: 0, width: 200, height: 200), isTapped: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        // This non-generic function dramatically improves compilation times of complex expressions.
        func fastFloor(_ x: CGFloat) -> CGFloat { return floor(x) }
    ...
    public dynamic class func drawTitleLabel(frame: CGRect = CGRect(x: 0, y: 0, width: 288, height: 54), labelText: String = "LABEL") {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        // This non-generic function dramatically improves compilation times of complex expressions.
        func fastFloor(_ x: CGFloat) -> CGFloat { return floor(x) }
        ...
        //// Subframes
        let group: CGRect = CGRect(x: frame.minX, y: frame.minY + 8, width: frame.width, height: frame.height - 18)
        ...
        let textFontAttributes = [NSFontAttributeName: UIFont(name: "Avenir-Roman", size: 28)!, NSForegroundColorAttributeName: UIColor.white, NSParagraphStyleAttributeName: textStyle]
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: group.minX + 0.12674 * group.width, y: group.minY + 0.98611 * group.height))
        bezierPath.addLine(to: CGPoint(x: group.minX + 0.87326 * group.width, y: group.minY + 0.98611 * group.height))
        UIColor.white.setStroke()
        bezierPath.lineWidth = 1
        bezierPath.stroke()
    ...
    public dynamic class func drawAdditionButton(frame: CGRect = CGRect(x: 14, y: 10, width: 75, height: 75), isTapped: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        // This non-generic function dramatically improves compilation times of complex expressions.
        func fastFloor(_ x: CGFloat) -> CGFloat { return floor(x) }
        ...
        //// Subframes
        let circle: CGRect = CGRect(x: frame.minX + fastFloor(frame.width * 0.01333 + 0.5), y: frame.minY + fastFloor(frame.height * 0.01333 + 0.5), width: fastFloor(frame.width * 0.93333 + 0.5) - fastFloor(frame.width * 0.01333 + 0.5), height: fastFloor(frame.height * 0.93333 + 0.5) - fastFloor(frame.height * 0.01333 + 0.5))
        let off: CGRect = CGRect(x: frame.minX + fastFloor(frame.width * 0.18667 + 0.5), y: frame.minY + fastFloor(frame.height * 0.20000 + 0.5), width: fastFloor(frame.width * 0.74667 + 0.5) - fastFloor(frame.width * 0.18667 + 0.5), height: fastFloor(frame.height * 0.76000 + 0.5) - fastFloor(frame.height * 0.20000 + 0.5))
        let on: CGRect = CGRect(x: frame.minX + fastFloor(frame.width * 0.18667 + 0.5), y: frame.minY + fastFloor(frame.height * 0.20000 + 0.5), width: fastFloor(frame.width * 0.74667 + 0.5) - fastFloor(frame.width * 0.18667 + 0.5), height: fastFloor(frame.height * 0.76000 + 0.5) - fastFloor(frame.height * 0.20000 + 0.5))
        ...
        if (isTapped) {
            //// Bezier 2 Drawing
            let bezier2Path = UIBezierPath()
            bezier2Path.move(to: CGPoint(x: circle.minX + 0.50000 * circle.width, y: circle.minY + 0.08696 * circle.height))
            bezier2Path.addCurve(to: CGPoint(x: circle.minX + 0.27478 * circle.width, y: circle.minY + 0.15370 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.41691 * circle.width, y: circle.minY + 0.08696 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.33956 * circle.width, y: circle.minY + 0.11149 * circle.height))
            bezier2Path.addCurve(to: CGPoint(x: circle.minX + 0.08696 * circle.width, y: circle.minY + 0.50000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.16171 * circle.width, y: circle.minY + 0.22739 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.08696 * circle.width, y: circle.minY + 0.35497 * circle.height))
            bezier2Path.addCurve(to: CGPoint(x: circle.minX + 0.50000 * circle.width, y: circle.minY + 0.91304 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.08696 * circle.width, y: circle.minY + 0.72812 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.27188 * circle.width, y: circle.minY + 0.91304 * circle.height))
            bezier2Path.addCurve(to: CGPoint(x: circle.minX + 0.91304 * circle.width, y: circle.minY + 0.50000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.72812 * circle.width, y: circle.minY + 0.91304 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.91304 * circle.width, y: circle.minY + 0.72812 * circle.height))
            bezier2Path.addCurve(to: CGPoint(x: circle.minX + 0.50000 * circle.width, y: circle.minY + 0.08696 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.91304 * circle.width, y: circle.minY + 0.27188 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.72812 * circle.width, y: circle.minY + 0.08696 * circle.height))
            bezier2Path.close()
            bezier2Path.move(to: CGPoint(x: circle.minX + 1.00000 * circle.width, y: circle.minY + 0.50000 * circle.height))
            bezier2Path.addCurve(to: CGPoint(x: circle.minX + 0.50000 * circle.width, y: circle.minY + 1.00000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 1.00000 * circle.width, y: circle.minY + 0.77614 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.77614 * circle.width, y: circle.minY + 1.00000 * circle.height))
            bezier2Path.addCurve(to: CGPoint(x: circle.minX + 0.00000 * circle.width, y: circle.minY + 0.50000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.22386 * circle.width, y: circle.minY + 1.00000 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.00000 * circle.width, y: circle.minY + 0.77614 * circle.height))
            bezier2Path.addCurve(to: CGPoint(x: circle.minX + 0.19793 * circle.width, y: circle.minY + 0.10153 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.00000 * circle.width, y: circle.minY + 0.33735 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.07766 * circle.width, y: circle.minY + 0.19284 * circle.height))
            bezier2Path.addCurve(to: CGPoint(x: circle.minX + 0.50000 * circle.width, y: circle.minY + 0.00000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.28184 * circle.width, y: circle.minY + 0.03781 * circle.height), controlPoint2: CGPoint(x: circle.minX + 0.38651 * circle.width, y: circle.minY + 0.00000 * circle.height))
            bezier2Path.addCurve(to: CGPoint(x: circle.minX + 1.00000 * circle.width, y: circle.minY + 0.50000 * circle.height), controlPoint1: CGPoint(x: circle.minX + 0.77614 * circle.width, y: circle.minY + 0.00000 * circle.height), controlPoint2: CGPoint(x: circle.minX + 1.00000 * circle.width, y: circle.minY + 0.22386 * circle.height))
            bezier2Path.close()
            MightyMetUI.yellowOrange.setFill()
            bezier2Path.fill()
        }
        ...
        //// Bezier 3 Drawing
        let bezier3Path = UIBezierPath()
        bezier3Path.move(to: CGPoint(x: off.minX + 0.54762 * off.width, y: off.minY + 0.00004 * off.height))
        bezier3Path.addCurve(to: CGPoint(x: off.minX + 0.54762 * off.width, y: off.minY + 0.45238 * off.height), controlPoint1: CGPoint(x: off.minX + 0.54762 * off.width, y: off.minY + -0.00000 * off.height), controlPoint2: CGPoint(x: off.minX + 0.54762 * off.width, y: off.minY + 0.21922 * off.height))
        bezier3Path.addLine(to: CGPoint(x: off.minX + 1.00000 * off.width, y: off.minY + 0.45238 * off.height))
        bezier3Path.addLine(to: CGPoint(x: off.minX + 1.00000 * off.width, y: off.minY + 0.54762 * off.height))
        bezier3Path.addLine(to: CGPoint(x: off.minX + 0.54762 * off.width, y: off.minY + 0.54762 * off.height))
        bezier3Path.addCurve(to: CGPoint(x: off.minX + 0.54762 * off.width, y: off.minY + 1.00000 * off.height), controlPoint1: CGPoint(x: off.minX + 0.54762 * off.width, y: off.minY + 0.78078 * off.height), controlPoint2: CGPoint(x: off.minX + 0.54762 * off.width, y: off.minY + 1.00000 * off.height))
        bezier3Path.addLine(to: CGPoint(x: off.minX + 0.45238 * off.width, y: off.minY + 1.00000 * off.height))
        bezier3Path.addCurve(to: CGPoint(x: off.minX + 0.45238 * off.width, y: off.minY + 0.54762 * off.height), controlPoint1: CGPoint(x: off.minX + 0.45238 * off.width, y: off.minY + 1.00000 * off.height), controlPoint2: CGPoint(x: off.minX + 0.45238 * off.width, y: off.minY + 0.78078 * off.height))
        bezier3Path.addLine(to: CGPoint(x: off.minX + 0.00000 * off.width, y: off.minY + 0.54762 * off.height))
        bezier3Path.addLine(to: CGPoint(x: off.minX + 0.00000 * off.width, y: off.minY + 0.45238 * off.height))
        bezier3Path.addLine(to: CGPoint(x: off.minX + 0.45238 * off.width, y: off.minY + 0.45238 * off.height))
        bezier3Path.addCurve(to: CGPoint(x: off.minX + 0.45238 * off.width, y: off.minY + 0.00000 * off.height), controlPoint1: CGPoint(x: off.minX + 0.45238 * off.width, y: off.minY + 0.21922 * off.height), controlPoint2: CGPoint(x: off.minX + 0.45238 * off.width, y: off.minY + 0.00000 * off.height))
        bezier3Path.addLine(to: CGPoint(x: off.minX + 0.54762 * off.width, y: off.minY + 0.00000 * off.height))
        bezier3Path.addLine(to: CGPoint(x: off.minX + 0.54762 * off.width, y: off.minY + 0.00004 * off.height))
        bezier3Path.close()
        MightyMetUI.transparent.setFill()
        bezier3Path.fill()
        ...
        if (isTapped) {
            ...
            //// Bezier 4 Drawing
            let bezier4Path = UIBezierPath()
            bezier4Path.move(to: CGPoint(x: on.minX + 0.54762 * on.width, y: on.minY + 0.00004 * on.height))
            bezier4Path.addCurve(to: CGPoint(x: on.minX + 0.54762 * on.width, y: on.minY + 0.45238 * on.height), controlPoint1: CGPoint(x: on.minX + 0.54762 * on.width, y: on.minY + -0.00000 * on.height), controlPoint2: CGPoint(x: on.minX + 0.54762 * on.width, y: on.minY + 0.21922 * on.height))
            bezier4Path.addLine(to: CGPoint(x: on.minX + 1.00000 * on.width, y: on.minY + 0.45238 * on.height))
            bezier4Path.addLine(to: CGPoint(x: on.minX + 1.00000 * on.width, y: on.minY + 0.54762 * on.height))
            bezier4Path.addLine(to: CGPoint(x: on.minX + 0.54762 * on.width, y: on.minY + 0.54762 * on.height))
            bezier4Path.addCurve(to: CGPoint(x: on.minX + 0.54762 * on.width, y: on.minY + 1.00000 * on.height), controlPoint1: CGPoint(x: on.minX + 0.54762 * on.width, y: on.minY + 0.78078 * on.height), controlPoint2: CGPoint(x: on.minX + 0.54762 * on.width, y: on.minY + 1.00000 * on.height))
            bezier4Path.addLine(to: CGPoint(x: on.minX + 0.45238 * on.width, y: on.minY + 1.00000 * on.height))
            bezier4Path.addCurve(to: CGPoint(x: on.minX + 0.45238 * on.width, y: on.minY + 0.54762 * on.height), controlPoint1: CGPoint(x: on.minX + 0.45238 * on.width, y: on.minY + 1.00000 * on.height), controlPoint2: CGPoint(x: on.minX + 0.45238 * on.width, y: on.minY + 0.78078 * on.height))
            bezier4Path.addLine(to: CGPoint(x: on.minX + 0.00000 * on.width, y: on.minY + 0.54762 * on.height))
            bezier4Path.addLine(to: CGPoint(x: on.minX + 0.00000 * on.width, y: on.minY + 0.45238 * on.height))
            bezier4Path.addLine(to: CGPoint(x: on.minX + 0.45238 * on.width, y: on.minY + 0.45238 * on.height))
            bezier4Path.addCurve(to: CGPoint(x: on.minX + 0.45238 * on.width, y: on.minY + 0.00000 * on.height), controlPoint1: CGPoint(x: on.minX + 0.45238 * on.width, y: on.minY + 0.21922 * on.height), controlPoint2: CGPoint(x: on.minX + 0.45238 * on.width, y: on.minY + 0.00000 * on.height))
            bezier4Path.addLine(to: CGPoint(x: on.minX + 0.54762 * on.width, y: on.minY + 0.00000 * on.height))
            bezier4Path.addLine(to: CGPoint(x: on.minX + 0.54762 * on.width, y: on.minY + 0.00004 * on.height))
            bezier4Path.close()
            MightyMetUI.yellowOrange.setFill()
            bezier4Path.fill()
    ...
    public dynamic class func drawDividerLine(frame: CGRect = CGRect(x: 0, y: 0, width: 288, height: 13)) {


        //// Subframes
        let group: CGRect = CGRect(x: frame.minX + 38.5, y: frame.minY + 6.5, width: frame.width - 73, height: frame.height - 13)


        //// Group
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: group.minX + 0.00000 * group.width, y: group.minY + 1.00000 * group.height))
